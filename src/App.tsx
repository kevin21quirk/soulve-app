...
const ForCharities = lazy(() => import("@/pages/ForCharities"));
const ForVolunteers = lazy(() => import("@/pages/ForVolunteers"));
const ForBusinesses = lazy(() => import("@/pages/ForBusinesses"));
const ForDonors = lazy(() => import("@/pages/ForDonors"));
const ForPhilanthropists = lazy(() => import("@/pages/ForPhilanthropists"));
const ForGovernance = lazy(() => import("@/pages/ForGovernance"));
const ForPublic = lazy(() => import("@/pages/ForPublic"));
const ForCommunityGroups = lazy(() => import("@/pages/ForCommunityGroups"));

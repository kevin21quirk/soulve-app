    ...
    <div className="relative overflow-hidden bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-lg mb-10 max-w-3xl mx-auto text-cyan-100">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Button size="lg" className="bg-white text-teal-600 hover:bg-teal-50 transform hover:scale-105 transition-all duration-200 text-lg px-8 py-4 font-semibold shadow-lg" asChild>
              <a href="/dashboard">

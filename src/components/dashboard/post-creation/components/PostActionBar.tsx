      ...
      <div className="border-t border-gray-100 p-3 space-y-3">
        ...
        <div className="flex items-center space-x-1 overflow-x-auto scrollbar-hide">
          ...
          <Button 
            ...
            variant="ghost" 
            size="sm" 
            className={`${formData.isLiveVideo ? 'bg-red-50 text-red-600' : 'text-red-600 hover:bg-red-50'} flex-shrink-0`}
          ...
          <Button 
            ...
            variant="ghost" 
            size="sm" 
            className={`${formData.hasGif ? 'bg-purple-50 text-purple-600' : 'text-purple-600 hover:bg-purple-50'} flex-shrink-0`}
          ...
          <Button 
            ...
            variant="ghost" 
            size="sm" 
            className={`${formData.hasPoll ? 'bg-yellow-50 text-yellow-600' : 'text-yellow-600 hover:bg-yellow-50'} flex-shrink-0`}
          ...
          <Button 
            ...
            variant="ghost" 
            size="sm" 
            className={`${formData.isEvent ? 'bg-blue-50 text-blue-600' : 'text-blue-600 hover:bg-blue-50'} flex-shrink-0`}
          ...
          <select
            ...
            className="text-xs border-0 bg-transparent text-gray-600 focus:outline-none ml-2 flex-shrink-0"
          >
        ...
        <Button 
          type="submit"
          disabled={disabled}
          className="w-full bg-gradient-to-r from-[#0ce4af] to-[#18a5fe] text-white py-2.5 text-sm font-medium disabled:opacity-50 hover:from-[#0ce4af]/90 hover:to-[#18a5fe]/90"
        >

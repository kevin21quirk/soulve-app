...
DROP POLICY IF EXISTS user_privacy_settings_opt ON public.user_privacy_settings;
DROP POLICY IF EXISTS user_preferences_opt ON public.user_preferences;
DROP POLICY IF EXISTS user_badges_select_opt ON public.user_badges;
DROP POLICY IF EXISTS user_badges_insert_svc ON public.user_badges;
DROP POLICY IF EXISTS user_activities_opt ON public.user_activities;
DROP POLICY IF EXISTS user_achievements_opt ON public.user_achievements;
DROP POLICY IF EXISTS typing_indicators_update ON public.typing_indicators;
DROP POLICY IF EXISTS typing_indicators_select ON public.typing_indicators;
DROP POLICY IF EXISTS typing_indicators_insert ON public.typing_indicators;
...
DROP POLICY IF EXISTS profiles_update_opt ON public.profiles;
DROP POLICY IF EXISTS profiles_select_opt ON public.profiles;
DROP POLICY IF EXISTS profiles_insert_opt ON public.profiles;
...
DROP POLICY IF EXISTS post_interactions_update ON public.post_interactions;
DROP POLICY IF EXISTS post_interactions_select ON public.post_interactions;
DROP POLICY IF EXISTS post_interactions_insert ON public.post_interactions;
DROP POLICY IF EXISTS post_interactions_delete ON public.post_interactions;
DROP POLICY IF EXISTS organizations_update ON public.organizations;
DROP POLICY IF EXISTS organizations_select ON public.organizations;
DROP POLICY IF EXISTS organizations_insert ON public.organizations;
DROP POLICY IF EXISTS organizations_delete ON public.organizations;
DROP POLICY IF EXISTS organization_preferences_upsert ON public.organization_preferences;
DROP POLICY IF EXISTS organization_preferences_update ON public.organization_preferences;
DROP POLICY IF EXISTS organization_preferences_select ON public.organization_preferences;
...
DROP POLICY IF EXISTS notifications_opt ON public.notifications;
...
DROP POLICY IF EXISTS notification_filters_update ON public.notification_filters;
DROP POLICY IF EXISTS notification_filters_select ON public.notification_filters;
DROP POLICY IF EXISTS notification_filters_insert ON public.notification_filters;
DROP POLICY IF EXISTS notification_filters_delete ON public.notification_filters;
DROP POLICY IF EXISTS notification_delivery_log_update ON public.notification_delivery_log;
DROP POLICY IF EXISTS notification_delivery_log_select ON public.notification_delivery_log;
DROP POLICY IF EXISTS notification_delivery_log_insert ON public.notification_delivery_log;
DROP POLICY IF EXISTS notification_delivery_log_delete ON public.notification_delivery_log;
DROP POLICY IF EXISTS notification_analytics_update ON public.notification_analytics;
DROP POLICY IF EXISTS notification_analytics_select ON public.notification_analytics;
DROP POLICY IF EXISTS notification_analytics_insert ON public.notification_analytics;
DROP POLICY IF EXISTS notification_analytics_delete ON public.notification_analytics;
DROP POLICY IF EXISTS messages_update_participants ON public.messages;
DROP POLICY IF EXISTS messages_update ON public.messages;
DROP POLICY IF EXISTS messages_select_participants ON public.messages;
DROP POLICY IF EXISTS messages_select ON public.messages;
DROP POLICY IF EXISTS messages_insert_sender_is_self ON public.messages;
DROP POLICY IF EXISTS messages_insert ON public.messages;
DROP POLICY IF EXISTS messages_delete_sender ON public.messages;
DROP POLICY IF EXISTS messages_delete ON public.messages;
DROP POLICY IF EXISTS message_access_log_select ON public.message_access_log;
DROP POLICY IF EXISTS message_access_log_insert ON public.message_access_log;
DROP POLICY IF EXISTS impact_metrics_service ON public.impact_metrics;
DROP POLICY IF EXISTS impact_metrics_select_opt ON public.impact_metrics;
DROP POLICY IF EXISTS impact_activities_opt ON public.impact_activities;
...
DROP POLICY IF EXISTS connections_opt ON public.connections;
...
DROP POLICY IF EXISTS campaign_participants_opt ON public.campaign_participants;
...
DROP POLICY IF EXISTS admin_roles_admin_all_fixed ON public.admin_roles;
DROP POLICY IF EXISTS "Users can view translations for accessible content" ON public.content_translations;
DROP POLICY IF EXISTS "Users can view their scheduled notifications" ON public.scheduled_notifications;
DROP POLICY IF EXISTS "Users can view their payment references" ON public.payment_references;
DROP POLICY IF EXISTS "Users can view their own volunteer interests" ON public.volunteer_interests;
...
DROP POLICY IF EXISTS "Users can view their own trust domains" ON public.trust_domains;
DROP POLICY IF EXISTS "Users can view their own support actions" ON public.support_actions;
...
DROP POLICY IF EXISTS "Users can view their own reference checks" ON public.safe_space_reference_checks;
DROP POLICY IF EXISTS "Users can view their own redemptions" ON public.point_redemptions;
DROP POLICY IF EXISTS "Users can view their own red flags" ON public.red_flags;
DROP POLICY IF EXISTS "Users can view their own recommendations" ON public.recommendation_cache;
DROP POLICY IF EXISTS "Users can view their own rate limits" ON public.rate_limit_buckets;
...
DROP POLICY IF EXISTS "Users can view their own payments" ON public.platform_payments;
DROP POLICY IF EXISTS "Users can view their own notifications" ON public.volunteer_work_notifications;
...
DROP POLICY IF EXISTS "Users can view their own interaction scores" ON public.user_interaction_scores;
DROP POLICY IF EXISTS "Users can view their own impact goals" ON public.impact_goals;
DROP POLICY IF EXISTS "Users can view their own impact activities" ON public.impact_activities;
...
DROP POLICY IF EXISTS "Users can view their own documents" ON public.safe_space_verification_documents;
DROP POLICY IF EXISTS "Users can view their own delivery logs" ON public.notification_delivery_log;
DROP POLICY IF EXISTS "Users can view their own decay log" ON public.point_decay_log;
DROP POLICY IF EXISTS "Users can view their own conversation participation" ON public.conversation_participants;
DROP POLICY IF EXISTS "Users can view their own campaigns" ON public.campaigns;
DROP POLICY IF EXISTS "Users can view their own blocks" ON public.user_blocks;
DROP POLICY IF EXISTS "Users can view their own badge awards" ON public.badge_award_log;
DROP POLICY IF EXISTS "Users can view their own applications" ON public.volunteer_applications;
DROP POLICY IF EXISTS "Users can view their own applications" ON public.safe_space_helper_applications;
DROP POLICY IF EXISTS "Users can view their own appeals" ON public.content_appeals;
DROP POLICY IF EXISTS "Users can view their own analytics" ON public.notification_analytics;
DROP POLICY IF EXISTS "Users can view their conversations" ON public.conversations;
DROP POLICY IF EXISTS "Users can view story updates for posts they're involved with" ON public.story_updates;
DROP POLICY IF EXISTS "Users can view relive stories they're involved with" ON public.relive_stories;
DROP POLICY IF EXISTS "Users can view relevant post reactions" ON public.post_reactions;
DROP POLICY IF EXISTS "Users can view public groups" ON public.groups;
DROP POLICY IF EXISTS "Users can view participants for stories they're involved with" ON public.story_participants;
DROP POLICY IF EXISTS "Users can view own tutorial progress" ON public.user_tutorial_progress;
DROP POLICY IF EXISTS "Users can view own tutorial preferences" ON public.tutorial_preferences;
DROP POLICY IF EXISTS "Users can view own training progress" ON public.safe_space_helper_training_progress;
DROP POLICY IF EXISTS "Users can view organization members" ON public.organization_members;
DROP POLICY IF EXISTS "Users can view org member list if they are members" ON public.organization_members;
DROP POLICY IF EXISTS "Users can view only their own impact metrics" ON public.impact_metrics;
DROP POLICY IF EXISTS "Users can view language detection cache" ON public.language_detection_cache;
DROP POLICY IF EXISTS "Users can view invitations sent to them" ON public.campaign_invitations;
DROP POLICY IF EXISTS "Users can view group memberships" ON public.group_members;
DROP POLICY IF EXISTS "Users can view followers" ON public.organization_followers;
DROP POLICY IF EXISTS "Users can view comment likes" ON public.comment_likes;
DROP POLICY IF EXISTS "Users can upload their own documents" ON public.safe_space_verification_documents;
DROP POLICY IF EXISTS "Users can update their scheduled notifications" ON public.scheduled_notifications;
DROP POLICY IF EXISTS "Users can update their own volunteer interests" ON public.volunteer_interests;
DROP POLICY IF EXISTS "Users can update their own verifications" ON public.user_verifications;
DROP POLICY IF EXISTS "Users can update their own trust domains" ON public.trust_domains;
DROP POLICY IF EXISTS "Users can update their own training progress" ON public.safe_space_helper_training_progress;
...
DROP POLICY IF EXISTS "Users can update their own notifications" ON public.volunteer_work_notifications;
...
DROP POLICY IF EXISTS "Users can update their own impact metrics" ON public.impact_metrics;
DROP POLICY IF EXISTS "Users can update their own impact goals" ON public.impact_goals;
DROP POLICY IF EXISTS "Users can update their own draft applications" ON public.safe_space_helper_applications;
DROP POLICY IF EXISTS "Users can update their own campaigns" ON public.campaigns;
DROP POLICY IF EXISTS "Users can update their own campaign interactions" ON public.campaign_interactions;
DROP POLICY IF EXISTS "Users can update their follow settings" ON public.organization_followers;
DROP POLICY IF EXISTS "Users can update own tutorial progress" ON public.user_tutorial_progress;
DROP POLICY IF EXISTS "Users can update own tutorial preferences" ON public.tutorial_preferences;
DROP POLICY IF EXISTS "Users can update own reviews" ON public.organization_reviews;
DROP POLICY IF EXISTS "Users can update own presence" ON public.user_presence;
DROP POLICY IF EXISTS "Users can update own membership" ON public.organization_members;
DROP POLICY IF EXISTS "Users can update own campaign interactions" ON public.campaign_interactions;
...
DROP POLICY IF EXISTS "Users can read URL previews" ON public.url_previews;
DROP POLICY IF EXISTS "Users can manage their typing status" ON public.typing_indicators;
DROP POLICY IF EXISTS "Users can manage their queue position" ON public.safe_space_queue;
DROP POLICY IF EXISTS "Users can manage their own filters" ON public.notification_filters;
DROP POLICY IF EXISTS "Users can manage their own evidence" ON public.evidence_submissions;
...
DROP POLICY IF EXISTS "Users can insert their own trust domains" ON public.trust_domains;
...
DROP POLICY IF EXISTS "Users can insert their own impact metrics" ON public.impact_metrics;
DROP POLICY IF EXISTS "Users can insert their own feedback" ON public.platform_feedback;
DROP POLICY IF EXISTS "Users can insert their own analytics" ON public.notification_analytics;
DROP POLICY IF EXISTS "Users can insert their own activities" ON public.impact_activities;
DROP POLICY IF EXISTS "Users can insert own tutorial progress" ON public.user_tutorial_progress;
DROP POLICY IF EXISTS "Users can insert own tutorial preferences" ON public.tutorial_preferences;
...
DROP POLICY IF EXISTS "Users can delete their scheduled notifications" ON public.scheduled_notifications;
DROP POLICY IF EXISTS "Users can delete their own unverified documents" ON public.safe_space_verification_documents;
...
DROP POLICY IF EXISTS "Users can delete their own impact goals" ON public.impact_goals;
DROP POLICY IF EXISTS "Users can delete their own campaign interactions" ON public.campaign_interactions;
DROP POLICY IF EXISTS "Users can delete their own blocks" ON public.user_blocks;
DROP POLICY IF EXISTS "Users can delete own tutorial progress" ON public.user_tutorial_progress;
DROP POLICY IF EXISTS "Users can delete own tutorial preferences" ON public.tutorial_preferences;
DROP POLICY IF EXISTS "Users can delete own reviews" ON public.organization_reviews;
DROP POLICY IF EXISTS "Users can delete own campaign interactions" ON public.campaign_interactions;
DROP POLICY IF EXISTS "Users can create volunteer interests" ON public.volunteer_interests;
DROP POLICY IF EXISTS "Users can create their own verifications" ON public.user_verifications;
DROP POLICY IF EXISTS "Users can create their own training progress" ON public.safe_space_helper_training_progress;
DROP POLICY IF EXISTS "Users can create their own questionnaire responses" ON public.questionnaire_responses;
DROP POLICY IF EXISTS "Users can create their own post reactions" ON public.post_reactions;
DROP POLICY IF EXISTS "Users can create their own payments" ON public.platform_payments;
DROP POLICY IF EXISTS "Users can create their own interaction scores" ON public.user_interaction_scores;
DROP POLICY IF EXISTS "Users can create their own impact goals" ON public.impact_goals;
DROP POLICY IF EXISTS "Users can create their own impact activities" ON public.impact_activities;
DROP POLICY IF EXISTS "Users can create their own applications" ON public.safe_space_helper_applications;
DROP POLICY IF EXISTS "Users can create their own appeals" ON public.content_appeals;
DROP POLICY IF EXISTS "Users can create their own activities" ON public.user_activities;
DROP POLICY IF EXISTS "Users can create their activities" ON public.user_activities;
DROP POLICY IF EXISTS "Users can create support actions" ON public.support_actions;
DROP POLICY IF EXISTS "Users can create sessions" ON public.safe_space_sessions;
DROP POLICY IF EXISTS "Users can create scheduled notifications" ON public.scheduled_notifications;
DROP POLICY IF EXISTS "Users can create reviews" ON public.organization_reviews;
DROP POLICY IF EXISTS "Users can create reports" ON public.reports;
DROP POLICY IF EXISTS "Users can create reference checks for their application" ON public.safe_space_reference_checks;
DROP POLICY IF EXISTS "Users can create redemptions" ON public.point_redemptions;
DROP POLICY IF EXISTS "Users can create posts" ON public.posts;
DROP POLICY IF EXISTS "Users can create personal interactions" ON public.post_interactions;
DROP POLICY IF EXISTS "Users can create personal campaign interactions" ON public.campaign_interactions;
DROP POLICY IF EXISTS "Users can create organizations" ON public.organizations;
DROP POLICY IF EXISTS "Users can create org interactions if member" ON public.post_interactions;
DROP POLICY IF EXISTS "Users can create org campaign interactions if member" ON public.campaign_interactions;
...
DROP POLICY IF EXISTS "Users can create campaign interactions" ON public.campaign_interactions;
DROP POLICY IF EXISTS "Users can create blocks" ON public.user_blocks;
DROP POLICY IF EXISTS "Users can create applications" ON public.volunteer_applications;
...
DROP POLICY IF EXISTS "Users can add their own comment likes" ON public.comment_likes;
DROP POLICY IF EXISTS "Users and admins can update memberships" ON public.organization_members;
DROP POLICY IF EXISTS "Team members can view their organization members" ON public.organization_team_members;
DROP POLICY IF EXISTS "System manages rate limits" ON public.ai_endpoint_rate_limits;
DROP POLICY IF EXISTS "System functions can manage impact metrics" ON public.impact_metrics;
DROP POLICY IF EXISTS "System can read keywords" ON public.safe_space_flagged_keywords;
DROP POLICY IF EXISTS "System can manage trust scores" ON public.organization_trust_scores;
DROP POLICY IF EXISTS "System can manage story participants" ON public.story_participants;
DROP POLICY IF EXISTS "System can manage relive stories" ON public.relive_stories;
DROP POLICY IF EXISTS "System can manage recommendations" ON public.recommendation_cache;
DROP POLICY IF EXISTS "System can manage URL previews" ON public.url_previews;
DROP POLICY IF EXISTS "System can log message access" ON public.message_access_log;
DROP POLICY IF EXISTS "System can insert verification audit logs" ON public.esg_verification_audit_log;
DROP POLICY IF EXISTS "System can insert translations" ON public.content_translations;
DROP POLICY IF EXISTS "System can insert social metrics" ON public.campaign_social_metrics;
DROP POLICY IF EXISTS "System can insert predictions" ON public.campaign_predictions;
DROP POLICY IF EXISTS "System can insert lead tracking" ON public.csr_lead_tracking;
DROP POLICY IF EXISTS "System can insert geographic data" ON public.campaign_geographic_impact;
DROP POLICY IF EXISTS "System can insert engagement" ON public.campaign_engagement;
DROP POLICY IF EXISTS "System can insert donations" ON public.campaign_donations;
DROP POLICY IF EXISTS "System can insert detection cache" ON public.language_detection_cache;
DROP POLICY IF EXISTS "System can insert delivery logs" ON public.notification_delivery_log;
DROP POLICY IF EXISTS "System can insert audit logs" ON public.verification_document_audit;
DROP POLICY IF EXISTS "System can insert audit logs" ON public.safe_space_audit_log;
DROP POLICY IF EXISTS "System can insert audit logs" ON public.admin_action_log;
DROP POLICY IF EXISTS "System can insert analytics" ON public.campaign_analytics;
DROP POLICY IF EXISTS "System can insert activity logs" ON public.demo_request_activity_log;
DROP POLICY IF EXISTS "System can insert achievements" ON public.user_achievements;
DROP POLICY IF EXISTS "System can create red flags" ON public.red_flags;
DROP POLICY IF EXISTS "System can create notifications" ON public.volunteer_work_notifications;
DROP POLICY IF EXISTS "System can create fraud detection entries" ON public.fraud_detection_log;
DROP POLICY IF EXISTS "System can create decay log entries" ON public.point_decay_log;
DROP POLICY IF EXISTS "System can create badge awards" ON public.badge_award_log;
DROP POLICY IF EXISTS "System can create audit log" ON public.subscription_admin_actions;
DROP POLICY IF EXISTS "System can create alerts" ON public.safe_space_emergency_alerts;
DROP POLICY IF EXISTS "System can award badges" ON public.user_badges;
DROP POLICY IF EXISTS "Session participants can view messages" ON public.safe_space_messages;
DROP POLICY IF EXISTS "Session participants can send messages" ON public.safe_space_messages;
DROP POLICY IF EXISTS "Service role can manage rate limits" ON public.rate_limit_buckets;
DROP POLICY IF EXISTS "Service role can manage all activities" ON public.user_activities;
DROP POLICY IF EXISTS "Service role can insert audit logs" ON public.security_audit_log;
DROP POLICY IF EXISTS "Safeguarding staff can view audit logs" ON public.safe_space_audit_log;
DROP POLICY IF EXISTS "Safeguarding staff can view all applications" ON public.safe_space_helper_applications;
DROP POLICY IF EXISTS "Safeguarding staff can view alerts" ON public.safe_space_emergency_alerts;
DROP POLICY IF EXISTS "Safeguarding staff can update documents" ON public.safe_space_verification_documents;
DROP POLICY IF EXISTS "Safeguarding staff can update applications" ON public.safe_space_helper_applications;
DROP POLICY IF EXISTS "Safeguarding staff can update alerts" ON public.safe_space_emergency_alerts;
DROP POLICY IF EXISTS "Safeguarding staff can manage keywords" ON public.safe_space_flagged_keywords;
DROP POLICY IF EXISTS "Safeguarding leads can view all roles" ON public.safeguarding_roles;
DROP POLICY IF EXISTS "Safeguarding leads can manage roles" ON public.safeguarding_roles;
DROP POLICY IF EXISTS "Recipients can view volunteer work awaiting confirmation" ON public.impact_activities;
DROP POLICY IF EXISTS "Recipients can confirm volunteer work" ON public.impact_activities;
DROP POLICY IF EXISTS "Public can view verified helpers" ON public.safe_space_helpers;
DROP POLICY IF EXISTS "Public can view reference check by token" ON public.safe_space_reference_checks;
DROP POLICY IF EXISTS "Public can update reference check by token" ON public.safe_space_reference_checks;
...
DROP POLICY IF EXISTS "Public campaign updates are viewable by everyone" ON public.campaign_updates;
DROP POLICY IF EXISTS "Prevent invitation token enumeration" ON public.organization_invitations;
DROP POLICY IF EXISTS "Post authors can view volunteer interests on their posts" ON public.volunteer_interests;
DROP POLICY IF EXISTS "Post authors can view support actions on their posts" ON public.support_actions;
DROP POLICY IF EXISTS "Post authors can view opportunities" ON public.csr_opportunities;
DROP POLICY IF EXISTS "Post authors can update volunteer interests status" ON public.volunteer_interests;
DROP POLICY IF EXISTS "Post authors can manage completion requests" ON public.help_completion_requests;
DROP POLICY IF EXISTS "Post authors can create story updates" ON public.story_updates;
...
DROP POLICY IF EXISTS "Organizations can view their sponsorships" ON public.campaign_sponsorships;
DROP POLICY IF EXISTS "Organizations can view their lead tracking" ON public.csr_lead_tracking;
DROP POLICY IF EXISTS "Organizations can manage their opportunities" ON public.csr_opportunities;
DROP POLICY IF EXISTS "Organization members can view stakeholder metrics" ON public.stakeholder_engagement_metrics;
DROP POLICY IF EXISTS "Organization members can view stakeholder groups" ON public.stakeholder_groups;
DROP POLICY IF EXISTS "Organization members can view report versions" ON public.esg_report_versions;
DROP POLICY IF EXISTS "Organization members can view preferences" ON public.organization_preferences;
DROP POLICY IF EXISTS "Organization members can view partnerships" ON public.business_partnerships;
...
DROP POLICY IF EXISTS "Organization members can view initiatives" ON public.esg_initiatives;
DROP POLICY IF EXISTS "Organization members can view engagement" ON public.employee_engagement;
DROP POLICY IF EXISTS "Organization members can view data requests" ON public.esg_data_requests;
DROP POLICY IF EXISTS "Organization members can view compliance reports" ON public.esg_compliance_reports;
DROP POLICY IF EXISTS "Organization members can view carbon data" ON public.carbon_footprint_data;
DROP POLICY IF EXISTS "Organization members can view business products" ON public.business_products;
DROP POLICY IF EXISTS "Organization members can view applications" ON public.volunteer_applications;
DROP POLICY IF EXISTS "Organization members can view announcements" ON public.esg_announcements;
DROP POLICY IF EXISTS "Organization members can view ESG targets" ON public.esg_targets;
DROP POLICY IF EXISTS "Organization members can view ESG risks" ON public.esg_risks;
DROP POLICY IF EXISTS "Organization members can view ESG reports" ON public.esg_reports;
DROP POLICY IF EXISTS "Organization members can view ESG recommendations" ON public.esg_recommendations;
DROP POLICY IF EXISTS "Organization members can view ESG data" ON public.organization_esg_data;
DROP POLICY IF EXISTS "Organization members can view CSR initiatives" ON public.csr_initiatives;
DROP POLICY IF EXISTS "Organization members can manage volunteer opportunities" ON public.volunteer_opportunities;
DROP POLICY IF EXISTS "Organization members can manage their engagement" ON public.employee_engagement;
DROP POLICY IF EXISTS "Organization members can manage products" ON public.business_products;
DROP POLICY IF EXISTS "Organization members can manage partnerships" ON public.corporate_partnerships;
DROP POLICY IF EXISTS "Organization members can manage grants" ON public.grants;
DROP POLICY IF EXISTS "Organization members can manage ESG goals" ON public.esg_goals;
DROP POLICY IF EXISTS "Organization members can manage ESG data entries" ON public.esg_data_entries;
DROP POLICY IF EXISTS "Organization members can manage CSR initiatives" ON public.csr_initiatives;
DROP POLICY IF EXISTS "Organization creators can update their organizations" ON public.organizations;
DROP POLICY IF EXISTS "Organization admins have full access" ON public.organization_members;
DROP POLICY IF EXISTS "Organization admins can view verification logs" ON public.esg_verification_audit_log;
DROP POLICY IF EXISTS "Organization admins can view invitation details" ON public.organization_invitations;
DROP POLICY IF EXISTS "Organization admins can update invitations" ON public.organization_invitations;
DROP POLICY IF EXISTS "Organization admins can update data requests" ON public.esg_data_requests;
DROP POLICY IF EXISTS "Organization admins can manage team members" ON public.organization_team_members;
DROP POLICY IF EXISTS "Organization admins can manage stakeholder metrics" ON public.stakeholder_engagement_metrics;
DROP POLICY IF EXISTS "Organization admins can manage stakeholder groups" ON public.stakeholder_groups;
DROP POLICY IF EXISTS "Organization admins can manage sponsorships" ON public.campaign_sponsorships;
DROP POLICY IF EXISTS "Organization admins can manage settings" ON public.organization_settings;
DROP POLICY IF EXISTS "Organization admins can manage preferences" ON public.organization_preferences;
DROP POLICY IF EXISTS "Organization admins can manage partnerships" ON public.business_partnerships;
DROP POLICY IF EXISTS "Organization admins can manage materiality assessments" ON public.materiality_assessments;
DROP POLICY IF EXISTS "Organization admins can manage initiatives" ON public.esg_initiatives;
DROP POLICY IF EXISTS "Organization admins can manage compliance reports" ON public.esg_compliance_reports;
DROP POLICY IF EXISTS "Organization admins can manage carbon data" ON public.carbon_footprint_data;
DROP POLICY IF EXISTS "Organization admins can manage announcements" ON public.esg_announcements;
DROP POLICY IF EXISTS "Organization admins can manage ESG targets" ON public.esg_targets;
DROP POLICY IF EXISTS "Organization admins can manage ESG risks" ON public.esg_risks;
DROP POLICY IF EXISTS "Organization admins can manage ESG reports" ON public.esg_reports;
DROP POLICY IF EXISTS "Organization admins can manage ESG recommendations" ON public.esg_recommendations;
...
DROP POLICY IF EXISTS "Organization admins can create data requests" ON public.esg_data_requests;
DROP POLICY IF EXISTS "Org members can view advertising bookings" ON public.advertising_bookings;
DROP POLICY IF EXISTS "Org members can manage activities" ON public.organization_activities;
DROP POLICY IF EXISTS "Org admins can view white label purchases" ON public.white_label_purchases;
...
DROP POLICY IF EXISTS "Org admins can manage verifications" ON public.organization_verifications;
DROP POLICY IF EXISTS "Org admins can manage impact metrics" ON public.organization_impact_metrics;
DROP POLICY IF EXISTS "Org admins can add members" ON public.organization_members;
DROP POLICY IF EXISTS "Only admins can manage categories" ON public.blog_categories;
DROP POLICY IF EXISTS "Invited users can view their invitations" ON public.organization_invitations;
DROP POLICY IF EXISTS "Invited users can respond to invitations" ON public.organization_invitations;
DROP POLICY IF EXISTS "Helpers can view their completion requests" ON public.help_completion_requests;
...
DROP POLICY IF EXISTS "Helpers can update sessions" ON public.safe_space_sessions;
DROP POLICY IF EXISTS "Helpers can manage their availability" ON public.safe_space_helpers;
DROP POLICY IF EXISTS "Helpers can create completion requests" ON public.help_completion_requests;
DROP POLICY IF EXISTS "Helpers and safeguarding can view documents" ON public.safe_space_verification_documents;
...
DROP POLICY IF EXISTS "Fundraising staff can view donor data" ON public.donors;
DROP POLICY IF EXISTS "Fundraising staff can manage donors" ON public.donors;
DROP POLICY IF EXISTS "Everyone can view active volunteer opportunities" ON public.volunteer_opportunities;
DROP POLICY IF EXISTS "Enforce team member limits on insert" ON public.organization_members;
DROP POLICY IF EXISTS "ESG benchmarks are viewable by organization members" ON public.esg_benchmarks;
DROP POLICY IF EXISTS "Contributors can view their own submissions" ON public.stakeholder_data_contributions;
DROP POLICY IF EXISTS "Contributors can view their contributions" ON public.stakeholder_data_contributions;
DROP POLICY IF EXISTS "Contributors can update their contributions" ON public.stakeholder_data_contributions;
DROP POLICY IF EXISTS "Contributors can create contributions" ON public.stakeholder_data_contributions;
DROP POLICY IF EXISTS "Campaign owners and admins can delete campaigns" ON public.campaigns;
DROP POLICY IF EXISTS "Campaign organizers can create updates" ON public.campaign_updates;
DROP POLICY IF EXISTS "Campaign creators can view their promotions" ON public.campaign_promotions;
DROP POLICY IF EXISTS "Campaign creators can view sponsorships" ON public.campaign_sponsorships;
DROP POLICY IF EXISTS "Campaign creators can view predictions" ON public.campaign_predictions;
DROP POLICY IF EXISTS "Campaign creators can view engagement" ON public.campaign_engagement;
DROP POLICY IF EXISTS "Campaign creators can view donations" ON public.campaign_donations;
DROP POLICY IF EXISTS "Campaign creators can view analytics" ON public.campaign_analytics;
DROP POLICY IF EXISTS "Campaign creators can send invitations" ON public.campaign_invitations;
DROP POLICY IF EXISTS "Campaign creators can create promotions" ON public.campaign_promotions;
DROP POLICY IF EXISTS "Authors can update their own story updates" ON public.story_updates;
DROP POLICY IF EXISTS "Authenticated users can view active ESG frameworks" ON public.esg_frameworks;
...
DROP POLICY IF EXISTS "Anyone can view trust scores" ON public.organization_trust_scores;
DROP POLICY IF EXISTS "Anyone can view subscription plans" ON public.subscription_plans;
DROP POLICY IF EXISTS "Anyone can view skill categories" ON public.skill_categories;
DROP POLICY IF EXISTS "Anyone can view reviews" ON public.organization_reviews;
DROP POLICY IF EXISTS "Anyone can view published blog posts" ON public.blog_posts;
DROP POLICY IF EXISTS "Anyone can view published activities" ON public.organization_activities;
DROP POLICY IF EXISTS "Anyone can view points config" ON public.points_configuration;
DROP POLICY IF EXISTS "Anyone can view impact metrics" ON public.organization_impact_metrics;
DROP POLICY IF EXISTS "Anyone can view blog categories" ON public.blog_categories;
DROP POLICY IF EXISTS "Anyone can view approved verifications" ON public.organization_verifications;
DROP POLICY IF EXISTS "Anyone can view active training modules" ON public.safe_space_training_modules;
DROP POLICY IF EXISTS "Anyone can view active templates" ON public.notification_templates;
DROP POLICY IF EXISTS "Anyone can view active templates" ON public.esg_initiative_templates;
DROP POLICY IF EXISTS "Anyone can view active challenges" ON public.seasonal_challenges;
DROP POLICY IF EXISTS "Anyone can view active badges" ON public.badges;
DROP POLICY IF EXISTS "Anyone can subscribe to newsletter" ON public.newsletter_subscriptions;
DROP POLICY IF EXISTS "Anyone can subscribe to newsletter" ON public.newsletter_subscribers;
DROP POLICY IF EXISTS "Anyone can submit partnership enquiries" ON public.partnership_enquiries;
DROP POLICY IF EXISTS "Anyone can submit contact forms" ON public.contact_submissions;
DROP POLICY IF EXISTS "Anyone can read published blog posts" ON public.blog_posts;
DROP POLICY IF EXISTS "Anyone can read blog categories" ON public.blog_categories;
DROP POLICY IF EXISTS "Admins can view user activities for moderation" ON public.user_activities;
DROP POLICY IF EXISTS "Admins can view subscription actions" ON public.subscription_admin_actions;
DROP POLICY IF EXISTS "Admins can view partnership enquiries" ON public.partnership_enquiries;
DROP POLICY IF EXISTS "Admins can view message access logs" ON public.message_access_log;
DROP POLICY IF EXISTS "Admins can view impact metrics for moderation" ON public.impact_metrics;
DROP POLICY IF EXISTS "Admins can view fraud detection log" ON public.fraud_detection_log;
DROP POLICY IF EXISTS "Admins can view contact submissions" ON public.contact_submissions;
DROP POLICY IF EXISTS "Admins can view audit logs" ON public.verification_document_audit;
DROP POLICY IF EXISTS "Admins can view audit logs" ON public.security_audit_log;
DROP POLICY IF EXISTS "Admins can view audit log" ON public.admin_action_log;
...
DROP POLICY IF EXISTS "Admins can view all verification documents" ON public.safe_space_verification_documents;
DROP POLICY IF EXISTS "Admins can view all training progress" ON public.safe_space_helper_training_progress;
DROP POLICY IF EXISTS "Admins can view all reports" ON public.content_reports;
DROP POLICY IF EXISTS "Admins can view all reference checks" ON public.safe_space_reference_checks;
DROP POLICY IF EXISTS "Admins can view all red flags" ON public.red_flags;
...
DROP POLICY IF EXISTS "Admins can view all evidence" ON public.evidence_submissions;
DROP POLICY IF EXISTS "Admins can view all demo requests" ON public.demo_requests;
DROP POLICY IF EXISTS "Admins can view all appeals" ON public.content_appeals;
DROP POLICY IF EXISTS "Admins can view activity logs" ON public.demo_request_activity_log;
...
DROP POLICY IF EXISTS "Admins can update document verification status" ON public.safe_space_verification_documents;
DROP POLICY IF EXISTS "Admins can update demo requests" ON public.demo_requests;
DROP POLICY IF EXISTS "Admins can update appeals" ON public.content_appeals;
DROP POLICY IF EXISTS "Admins can update any profile" ON public.profiles;
DROP POLICY IF EXISTS "Admins can update all verifications" ON public.user_verifications;
DROP POLICY IF EXISTS "Admins can update all training progress" ON public.safe_space_helper_training_progress;
...
DROP POLICY IF EXISTS "Admins can manage training modules" ON public.safe_space_training_modules;
DROP POLICY IF EXISTS "Admins can manage templates" ON public.notification_templates;
DROP POLICY IF EXISTS "Admins can manage templates" ON public.esg_initiative_templates;
DROP POLICY IF EXISTS "Admins can manage subscriptions" ON public.newsletter_subscribers;
DROP POLICY IF EXISTS "Admins can manage points config" ON public.points_configuration;
...
DROP POLICY IF EXISTS "Admins can manage all badge awards" ON public.badge_award_log;
DROP POLICY IF EXISTS "Admins can delete demo requests" ON public.demo_requests;
ALTER TABLE IF EXISTS ONLY public.white_label_purchases DROP CONSTRAINT IF EXISTS white_label_purchases_payment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.white_label_purchases DROP CONSTRAINT IF EXISTS white_label_purchases_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_work_notifications DROP CONSTRAINT IF EXISTS volunteer_work_notifications_volunteer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_work_notifications DROP CONSTRAINT IF EXISTS volunteer_work_notifications_recipient_id_fkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_work_notifications DROP CONSTRAINT IF EXISTS volunteer_work_notifications_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_interests DROP CONSTRAINT IF EXISTS volunteer_interests_volunteer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_interests DROP CONSTRAINT IF EXISTS volunteer_interests_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.verification_documents DROP CONSTRAINT IF EXISTS verification_documents_verification_id_fkey;
ALTER TABLE IF EXISTS ONLY public.verification_documents DROP CONSTRAINT IF EXISTS verification_documents_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.verification_document_audit DROP CONSTRAINT IF EXISTS verification_document_audit_document_id_fkey;
ALTER TABLE IF EXISTS ONLY public.verification_document_audit DROP CONSTRAINT IF EXISTS verification_document_audit_accessed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.user_verifications DROP CONSTRAINT IF EXISTS user_verifications_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.user_verifications DROP CONSTRAINT IF EXISTS user_verifications_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_tutorial_progress DROP CONSTRAINT IF EXISTS user_tutorial_progress_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.user_subscriptions DROP CONSTRAINT IF EXISTS user_subscriptions_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_privacy_settings DROP CONSTRAINT IF EXISTS user_privacy_settings_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_presence DROP CONSTRAINT IF EXISTS user_presence_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_presence DROP CONSTRAINT IF EXISTS user_presence_typing_to_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.user_interaction_scores DROP CONSTRAINT IF EXISTS user_interaction_scores_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_interaction_scores DROP CONSTRAINT IF EXISTS user_interaction_scores_target_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_interaction_scores DROP CONSTRAINT IF EXISTS user_interaction_scores_target_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_challenge_progress DROP CONSTRAINT IF EXISTS user_challenge_progress_challenge_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_blocks DROP CONSTRAINT IF EXISTS user_blocks_blocker_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_blocks DROP CONSTRAINT IF EXISTS user_blocks_blocked_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.tutorial_preferences DROP CONSTRAINT IF EXISTS tutorial_preferences_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trust_score_history DROP CONSTRAINT IF EXISTS trust_score_history_verification_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trust_score_history DROP CONSTRAINT IF EXISTS trust_score_history_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trust_domains DROP CONSTRAINT IF EXISTS trust_domains_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_actions DROP CONSTRAINT IF EXISTS support_actions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_actions DROP CONSTRAINT IF EXISTS support_actions_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subscription_admin_actions DROP CONSTRAINT IF EXISTS subscription_admin_actions_target_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.subscription_admin_actions DROP CONSTRAINT IF EXISTS subscription_admin_actions_admin_id_fkey;
ALTER TABLE IF EXISTS ONLY public.story_updates DROP CONSTRAINT IF EXISTS story_updates_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.story_updates DROP CONSTRAINT IF EXISTS story_updates_author_id_fkey;
ALTER TABLE IF EXISTS ONLY public.story_participants DROP CONSTRAINT IF EXISTS story_participants_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.story_participants DROP CONSTRAINT IF EXISTS story_participants_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_engagement_metrics DROP CONSTRAINT IF EXISTS stakeholder_engagement_metrics_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_engagement_metrics DROP CONSTRAINT IF EXISTS stakeholder_engagement_metrics_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_data_contributions DROP CONSTRAINT IF EXISTS stakeholder_data_contributions_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_data_contributions DROP CONSTRAINT IF EXISTS stakeholder_data_contributions_esg_data_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_data_contributions DROP CONSTRAINT IF EXISTS stakeholder_data_contributions_data_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_data_contributions DROP CONSTRAINT IF EXISTS stakeholder_data_contributions_contributor_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.security_audit_log DROP CONSTRAINT IF EXISTS security_audit_log_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.scheduled_notifications DROP CONSTRAINT IF EXISTS scheduled_notifications_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safeguarding_roles DROP CONSTRAINT IF EXISTS safeguarding_roles_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safeguarding_roles DROP CONSTRAINT IF EXISTS safeguarding_roles_assigned_by_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_verification_documents DROP CONSTRAINT IF EXISTS safe_space_verification_documents_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_verification_documents DROP CONSTRAINT IF EXISTS safe_space_verification_documents_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_verification_documents DROP CONSTRAINT IF EXISTS safe_space_verification_documents_application_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_sessions DROP CONSTRAINT IF EXISTS safe_space_sessions_requester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_sessions DROP CONSTRAINT IF EXISTS safe_space_sessions_paused_by_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_sessions DROP CONSTRAINT IF EXISTS safe_space_sessions_helper_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_reference_checks DROP CONSTRAINT IF EXISTS safe_space_reference_checks_application_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_queue DROP CONSTRAINT IF EXISTS safe_space_queue_requester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_messages DROP CONSTRAINT IF EXISTS safe_space_messages_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helpers DROP CONSTRAINT IF EXISTS safe_space_helpers_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_training_progress DROP CONSTRAINT IF EXISTS safe_space_helper_training_progress_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_training_progress DROP CONSTRAINT IF EXISTS safe_space_helper_training_progress_module_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_applications DROP CONSTRAINT IF EXISTS safe_space_helper_applications_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_applications DROP CONSTRAINT IF EXISTS safe_space_helper_applications_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_flagged_keywords DROP CONSTRAINT IF EXISTS safe_space_flagged_keywords_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_emergency_alerts DROP CONSTRAINT IF EXISTS safe_space_emergency_alerts_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_emergency_alerts DROP CONSTRAINT IF EXISTS safe_space_emergency_alerts_message_id_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_emergency_alerts DROP CONSTRAINT IF EXISTS safe_space_emergency_alerts_assigned_to_fkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_audit_log DROP CONSTRAINT IF EXISTS safe_space_audit_log_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_reported_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.relive_stories DROP CONSTRAINT IF EXISTS relive_stories_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.red_flags DROP CONSTRAINT IF EXISTS red_flags_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.red_flags DROP CONSTRAINT IF EXISTS red_flags_resolved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.red_flags DROP CONSTRAINT IF EXISTS red_flags_flagged_by_fkey;
ALTER TABLE IF EXISTS ONLY public.recommendation_cache DROP CONSTRAINT IF EXISTS recommendation_cache_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.questionnaire_responses DROP CONSTRAINT IF EXISTS questionnaire_responses_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_waitlist_approved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_id_fkey;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_founding_member_granted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.posts DROP CONSTRAINT IF EXISTS posts_organization_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_parent_comment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.points_configuration DROP CONSTRAINT IF EXISTS points_configuration_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.point_decay_log DROP CONSTRAINT IF EXISTS point_decay_log_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.platform_payments DROP CONSTRAINT IF EXISTS platform_payments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.platform_payments DROP CONSTRAINT IF EXISTS platform_payments_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.platform_feedback DROP CONSTRAINT IF EXISTS platform_feedback_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payment_references DROP CONSTRAINT IF EXISTS payment_references_payment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organizations DROP CONSTRAINT IF EXISTS organizations_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_verifications DROP CONSTRAINT IF EXISTS organization_verifications_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_verifications DROP CONSTRAINT IF EXISTS organization_verifications_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_trust_scores DROP CONSTRAINT IF EXISTS organization_trust_scores_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_reviews DROP CONSTRAINT IF EXISTS organization_reviews_reviewer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_reviews DROP CONSTRAINT IF EXISTS organization_reviews_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_preferences DROP CONSTRAINT IF EXISTS organization_preferences_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_members DROP CONSTRAINT IF EXISTS organization_members_verified_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.organization_impact_metrics DROP CONSTRAINT IF EXISTS organization_impact_metrics_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_followers DROP CONSTRAINT IF EXISTS organization_followers_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_followers DROP CONSTRAINT IF EXISTS organization_followers_follower_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_esg_data DROP CONSTRAINT IF EXISTS organization_esg_data_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_esg_data DROP CONSTRAINT IF EXISTS organization_esg_data_indicator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.organization_esg_data DROP CONSTRAINT IF EXISTS organization_esg_data_collected_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_grouped_with_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_delivery_log DROP CONSTRAINT IF EXISTS notification_delivery_log_notification_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notification_analytics DROP CONSTRAINT IF EXISTS notification_analytics_notification_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.materiality_assessments DROP CONSTRAINT IF EXISTS materiality_assessments_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.materiality_assessments DROP CONSTRAINT IF EXISTS materiality_assessments_indicator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.materiality_assessments DROP CONSTRAINT IF EXISTS materiality_assessments_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.impact_activities DROP CONSTRAINT IF EXISTS impact_activities_skill_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.impact_activities DROP CONSTRAINT IF EXISTS impact_activities_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.impact_activities DROP CONSTRAINT IF EXISTS impact_activities_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.impact_activities DROP CONSTRAINT IF EXISTS impact_activities_confirmed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.help_completion_requests DROP CONSTRAINT IF EXISTS help_completion_requests_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS groups_admin_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.fraud_detection_log DROP CONSTRAINT IF EXISTS fraud_detection_log_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.fraud_detection_log DROP CONSTRAINT IF EXISTS fraud_detection_log_reviewer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.evidence_submissions DROP CONSTRAINT IF EXISTS evidence_submissions_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.evidence_submissions DROP CONSTRAINT IF EXISTS evidence_submissions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.evidence_submissions DROP CONSTRAINT IF EXISTS evidence_submissions_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_verification_audit_log DROP CONSTRAINT IF EXISTS esg_verification_audit_log_performed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_verification_audit_log DROP CONSTRAINT IF EXISTS esg_verification_audit_log_contribution_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_targets DROP CONSTRAINT IF EXISTS esg_targets_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_targets DROP CONSTRAINT IF EXISTS esg_targets_indicator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_targets DROP CONSTRAINT IF EXISTS esg_targets_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_reports DROP CONSTRAINT IF EXISTS esg_reports_previous_version_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_reports DROP CONSTRAINT IF EXISTS esg_reports_initiative_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_report_versions DROP CONSTRAINT IF EXISTS esg_report_versions_report_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_initiatives DROP CONSTRAINT IF EXISTS esg_initiatives_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_initiatives DROP CONSTRAINT IF EXISTS esg_initiatives_framework_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_initiatives DROP CONSTRAINT IF EXISTS esg_initiatives_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_initiative_templates DROP CONSTRAINT IF EXISTS esg_initiative_templates_framework_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_indicators DROP CONSTRAINT IF EXISTS esg_indicators_framework_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_data_requests DROP CONSTRAINT IF EXISTS esg_data_requests_requested_from_org_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_data_requests DROP CONSTRAINT IF EXISTS esg_data_requests_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_data_requests DROP CONSTRAINT IF EXISTS esg_data_requests_initiative_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_data_requests DROP CONSTRAINT IF EXISTS esg_data_requests_indicator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_data_requests DROP CONSTRAINT IF EXISTS esg_data_requests_framework_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_compliance_reports DROP CONSTRAINT IF EXISTS esg_compliance_reports_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_compliance_reports DROP CONSTRAINT IF EXISTS esg_compliance_reports_generated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_compliance_reports DROP CONSTRAINT IF EXISTS esg_compliance_reports_framework_id_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_compliance_reports DROP CONSTRAINT IF EXISTS esg_compliance_reports_approved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.esg_announcements DROP CONSTRAINT IF EXISTS esg_announcements_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.employee_engagement DROP CONSTRAINT IF EXISTS employee_engagement_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.demo_request_activity_log DROP CONSTRAINT IF EXISTS demo_request_activity_log_demo_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_opportunities DROP CONSTRAINT IF EXISTS csr_opportunities_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_opportunities DROP CONSTRAINT IF EXISTS csr_opportunities_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_lead_tracking DROP CONSTRAINT IF EXISTS csr_lead_tracking_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_lead_tracking DROP CONSTRAINT IF EXISTS csr_lead_tracking_post_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_lead_tracking DROP CONSTRAINT IF EXISTS csr_lead_tracking_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_lead_tracking DROP CONSTRAINT IF EXISTS csr_lead_tracking_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.csr_initiatives DROP CONSTRAINT IF EXISTS csr_initiatives_organization_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.content_reports DROP CONSTRAINT IF EXISTS content_reports_reviewed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.content_reports DROP CONSTRAINT IF EXISTS content_reports_reported_by_fkey;
ALTER TABLE IF EXISTS ONLY public.content_reports DROP CONSTRAINT IF EXISTS content_reports_content_owner_id_fkey;
ALTER TABLE IF EXISTS ONLY public.content_appeals DROP CONSTRAINT IF EXISTS content_appeals_report_id_fkey;
ALTER TABLE IF EXISTS ONLY public.connections DROP CONSTRAINT IF EXISTS connections_requester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.connections DROP CONSTRAINT IF EXISTS connections_addressee_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.carbon_footprint_data DROP CONSTRAINT IF EXISTS carbon_footprint_data_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.carbon_footprint_data DROP CONSTRAINT IF EXISTS carbon_footprint_data_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.campaigns DROP CONSTRAINT IF EXISTS campaigns_exclusive_badge_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaigns DROP CONSTRAINT IF EXISTS campaigns_creator_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_updates DROP CONSTRAINT IF EXISTS campaign_updates_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_updates DROP CONSTRAINT IF EXISTS campaign_updates_author_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_sponsorships DROP CONSTRAINT IF EXISTS campaign_sponsorships_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_sponsorships DROP CONSTRAINT IF EXISTS campaign_sponsorships_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_social_metrics DROP CONSTRAINT IF EXISTS campaign_social_metrics_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_promotions DROP CONSTRAINT IF EXISTS campaign_promotions_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_predictions DROP CONSTRAINT IF EXISTS campaign_predictions_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_participants DROP CONSTRAINT IF EXISTS campaign_participants_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_participants DROP CONSTRAINT IF EXISTS campaign_participants_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_invitations DROP CONSTRAINT IF EXISTS campaign_invitations_inviter_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_invitations DROP CONSTRAINT IF EXISTS campaign_invitations_invitee_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_invitations DROP CONSTRAINT IF EXISTS campaign_invitations_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_interactions DROP CONSTRAINT IF EXISTS campaign_interactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_interactions DROP CONSTRAINT IF EXISTS campaign_interactions_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_interactions DROP CONSTRAINT IF EXISTS campaign_interactions_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_interactions DROP CONSTRAINT IF EXISTS campaign_interactions_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_geographic_impact DROP CONSTRAINT IF EXISTS campaign_geographic_impact_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_engagement DROP CONSTRAINT IF EXISTS campaign_engagement_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_engagement DROP CONSTRAINT IF EXISTS campaign_engagement_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_donations DROP CONSTRAINT IF EXISTS campaign_donations_donor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_donations DROP CONSTRAINT IF EXISTS campaign_donations_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_analytics DROP CONSTRAINT IF EXISTS campaign_analytics_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.business_products DROP CONSTRAINT IF EXISTS business_products_organization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.business_partnerships DROP CONSTRAINT IF EXISTS business_partnerships_organization_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.badges DROP CONSTRAINT IF EXISTS badges_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_revoked_by_fkey;
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_badge_id_fkey;
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_awarded_by_fkey;
ALTER TABLE IF EXISTS ONLY public.ai_endpoint_rate_limits DROP CONSTRAINT IF EXISTS ai_endpoint_rate_limits_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.advertising_bookings DROP CONSTRAINT IF EXISTS advertising_bookings_payment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.advertising_bookings DROP CONSTRAINT IF EXISTS advertising_bookings_organisation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.admin_roles DROP CONSTRAINT IF EXISTS admin_roles_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.admin_roles DROP CONSTRAINT IF EXISTS admin_roles_granted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.admin_action_log DROP CONSTRAINT IF EXISTS admin_action_log_target_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.admin_action_log DROP CONSTRAINT IF EXISTS admin_action_log_admin_id_fkey;
DROP TRIGGER IF EXISTS update_volunteer_opportunities_updated_at ON public.volunteer_opportunities;
DROP TRIGGER IF EXISTS update_volunteer_interests_updated_at ON public.volunteer_interests;
...
DROP TRIGGER IF EXISTS update_trust_domains_updated_at ON public.trust_domains;
DROP TRIGGER IF EXISTS update_subscription_plans_updated_at ON public.subscription_plans;
DROP TRIGGER IF EXISTS update_story_updates_updated_at ON public.story_updates;
DROP TRIGGER IF EXISTS update_stakeholder_groups_updated_at ON public.stakeholder_groups;
DROP TRIGGER IF EXISTS update_safeguarding_roles_updated_at ON public.safeguarding_roles;
DROP TRIGGER IF EXISTS update_safe_space_training_modules_updated_at ON public.safe_space_training_modules;
DROP TRIGGER IF EXISTS update_safe_space_helper_training_progress_updated_at ON public.safe_space_helper_training_progress;
DROP TRIGGER IF EXISTS update_safe_space_helper_applications_updated_at ON public.safe_space_helper_applications;
DROP TRIGGER IF EXISTS update_relive_stories_updated_at ON public.relive_stories;
DROP TRIGGER IF EXISTS update_red_flags_updated_at ON public.red_flags;
DROP TRIGGER IF EXISTS update_recommendation_cache_updated_at ON public.recommendation_cache;
...
DROP TRIGGER IF EXISTS update_points_config_updated_at ON public.points_configuration;
DROP TRIGGER IF EXISTS update_organizations_updated_at ON public.organizations;
DROP TRIGGER IF EXISTS update_organization_team_members_updated_at ON public.organization_team_members;
DROP TRIGGER IF EXISTS update_organization_settings_updated_at ON public.organization_settings;
DROP TRIGGER IF EXISTS update_organization_preferences_updated_at ON public.organization_preferences;
DROP TRIGGER IF EXISTS update_organization_members_updated_at ON public.organization_members;
DROP TRIGGER IF EXISTS update_org_metrics_on_review ON public.organization_reviews;
DROP TRIGGER IF EXISTS update_org_metrics_on_activity ON public.organization_activities;
...
DROP TRIGGER IF EXISTS update_flagged_keywords_updated_at ON public.safe_space_flagged_keywords;
DROP TRIGGER IF EXISTS update_feedback_updated_at ON public.platform_feedback;
DROP TRIGGER IF EXISTS update_evidence_submissions_updated_at ON public.evidence_submissions;
DROP TRIGGER IF EXISTS update_esg_risks_updated_at ON public.esg_risks;
DROP TRIGGER IF EXISTS update_esg_reports_updated_at ON public.esg_reports;
DROP TRIGGER IF EXISTS update_esg_recommendations_updated_at ON public.esg_recommendations;
DROP TRIGGER IF EXISTS update_esg_initiatives_updated_at ON public.esg_initiatives;
DROP TRIGGER IF EXISTS update_esg_initiative_templates_updated_at ON public.esg_initiative_templates;
DROP TRIGGER IF EXISTS update_esg_goals_updated_at ON public.esg_goals;
DROP TRIGGER IF EXISTS update_esg_data_entries_updated_at ON public.esg_data_entries;
DROP TRIGGER IF EXISTS update_esg_benchmarks_updated_at ON public.esg_benchmarks;
DROP TRIGGER IF EXISTS update_employee_engagement_updated_at ON public.employee_engagement;
DROP TRIGGER IF EXISTS update_emergency_alerts_updated_at ON public.safe_space_emergency_alerts;
...
DROP TRIGGER IF EXISTS update_csr_opportunities_updated_at ON public.csr_opportunities;
DROP TRIGGER IF EXISTS update_csr_initiatives_updated_at ON public.csr_initiatives;
DROP TRIGGER IF EXISTS update_corporate_partnerships_updated_at ON public.corporate_partnerships;
DROP TRIGGER IF EXISTS update_content_reports_updated_at ON public.content_reports;
DROP TRIGGER IF EXISTS update_connections_updated_at ON public.connections;
DROP TRIGGER IF EXISTS update_campaigns_updated_at ON public.campaigns;
DROP TRIGGER IF EXISTS update_campaign_sponsorships_updated_at ON public.campaign_sponsorships;
DROP TRIGGER IF EXISTS update_campaign_interactions_updated_at ON public.campaign_interactions;
DROP TRIGGER IF EXISTS update_campaign_geographic_impact_updated_at ON public.campaign_geographic_impact;
DROP TRIGGER IF EXISTS update_campaign_donations_updated_at ON public.campaign_donations;
...
DROP TRIGGER IF EXISTS update_business_partnerships_updated_at ON public.business_partnerships;
...
DROP TRIGGER IF EXISTS trigger_update_market_value_metrics ON public.impact_activities;
DROP TRIGGER IF EXISTS trigger_sync_approved_helper ON public.safe_space_helper_applications;
DROP TRIGGER IF EXISTS trigger_notify_volunteer_work ON public.impact_activities;
DROP TRIGGER IF EXISTS trigger_notify_volunteer_status ON public.impact_activities;
DROP TRIGGER IF EXISTS trigger_expire_typing ON public.user_presence;
...
DROP TRIGGER IF EXISTS safe_space_session_ended ON public.safe_space_sessions;
...
DROP TRIGGER IF EXISTS profile_updated_at_trigger ON public.profiles;
DROP TRIGGER IF EXISTS process_queue_on_availability ON public.safe_space_helpers;
DROP TRIGGER IF EXISTS prevent_duplicate_connections_trigger ON public.connections;
DROP TRIGGER IF EXISTS p2p_messages_broadcast_trigger ON public.messages;
DROP TRIGGER IF EXISTS on_language_prefs_updated ON public.user_language_preferences;
DROP TRIGGER IF EXISTS on_helper_application_approved ON public.safe_space_helper_applications;
DROP TRIGGER IF EXISTS on_help_completion ON public.post_interactions;
DROP TRIGGER IF EXISTS on_help_approval ON public.help_completion_requests;
...
DROP TRIGGER IF EXISTS message_access_audit_trigger ON public.messages;
DROP TRIGGER IF EXISTS materiality_audit_trigger ON public.materiality_assessments;
...
DROP TRIGGER IF EXISTS help_approval_trigger ON public.help_completion_requests;
DROP TRIGGER IF EXISTS handle_updated_at ON public.content_appeals;
DROP TRIGGER IF EXISTS handle_profiles_updated_at ON public.profiles;
DROP TRIGGER IF EXISTS feedback_status_notification_trigger ON public.platform_feedback;
DROP TRIGGER IF EXISTS esg_initiative_milestone_trigger ON public.esg_initiatives;
DROP TRIGGER IF EXISTS esg_data_audit_trigger ON public.organization_esg_data;
DROP TRIGGER IF EXISTS create_relive_story_trigger ON public.help_completion_requests;
DROP TRIGGER IF EXISTS contribution_status_notification_trigger ON public.stakeholder_data_contributions;
DROP INDEX IF EXISTS public.post_interactions_unique_non_comment;
DROP INDEX IF EXISTS public.idx_volunteer_work_notifications_volunteer_id;
DROP INDEX IF EXISTS public.idx_volunteer_work_notifications_activity_id;
DROP INDEX IF EXISTS public.idx_volunteer_opportunities_org_id;
DROP INDEX IF EXISTS public.idx_volunteer_opportunities_created_by;
DROP INDEX IF EXISTS public.idx_volunteer_notifications_recipient;
DROP INDEX IF EXISTS public.idx_volunteer_interests_volunteer_id;
DROP INDEX IF EXISTS public.idx_volunteer_interests_status;
DROP INDEX IF EXISTS public.idx_volunteer_interests_post_id;
DROP INDEX IF EXISTS public.idx_volunteer_applications_user_id;
DROP INDEX IF EXISTS public.idx_volunteer_applications_opportunity_id;
...
DROP INDEX IF EXISTS public.idx_verification_document_audit_document_id;
DROP INDEX IF EXISTS public.idx_verification_document_audit_accessed_by;
DROP INDEX IF EXISTS public.idx_user_verifications_verified_by;
DROP INDEX IF EXISTS public.idx_user_verifications_user_id_status;
DROP INDEX IF EXISTS public.idx_user_verifications_user_id;
DROP INDEX IF EXISTS public.idx_user_verifications_status_created;
DROP INDEX IF EXISTS public.idx_user_verifications_face_match_score;
DROP INDEX IF EXISTS public.idx_user_tutorial_progress_user_id;
DROP INDEX IF EXISTS public.idx_user_tutorial_progress_tutorial_type;
DROP INDEX IF EXISTS public.idx_user_privacy_settings_user_id;
DROP INDEX IF EXISTS public.idx_user_priv_user;
DROP INDEX IF EXISTS public.idx_user_preferences_user_id;
DROP INDEX IF EXISTS public.idx_user_pref_user;
DROP INDEX IF EXISTS public.idx_user_interaction_scores_target_user_id;
DROP INDEX IF EXISTS public.idx_user_interaction_scores_target_post_id;
DROP INDEX IF EXISTS public.idx_user_challenge_progress_challenge_id;
...
DROP INDEX IF EXISTS public.idx_user_badge_user;
DROP INDEX IF EXISTS public.idx_user_activities_user_id_created_at;
DROP INDEX IF EXISTS public.idx_user_activities_user_id;
DROP INDEX IF EXISTS public.idx_user_activities_created_at;
DROP INDEX IF EXISTS public.idx_user_act_user;
DROP INDEX IF EXISTS public.idx_user_achievements_user_id;
DROP INDEX IF EXISTS public.idx_user_ach_user;
DROP INDEX IF EXISTS public.idx_url_previews_url;
DROP INDEX IF EXISTS public.idx_url_previews_expires_at;
DROP INDEX IF EXISTS public.idx_unique_active_helper_application;
DROP INDEX IF EXISTS public.idx_typing_indicators_user_partner;
DROP INDEX IF EXISTS public.idx_tutorial_preferences_user_id;
DROP INDEX IF EXISTS public.idx_trust_score_history_verification_id;
DROP INDEX IF EXISTS public.idx_trust_score_history_user_id;
DROP INDEX IF EXISTS public.idx_trust_domains_user_id;
DROP INDEX IF EXISTS public.idx_support_actions_user_id;
DROP INDEX IF EXISTS public.idx_support_actions_post_id;
DROP INDEX IF EXISTS public.idx_support_actions_action_type;
DROP INDEX IF EXISTS public.idx_story_updates_post_id;
DROP INDEX IF EXISTS public.idx_story_updates_author_id;
DROP INDEX IF EXISTS public.idx_story_participants_user_id;
DROP INDEX IF EXISTS public.idx_story_participants_post_id;
DROP INDEX IF EXISTS public.idx_stakeholder_metrics_created_by;
DROP INDEX IF EXISTS public.idx_stakeholder_groups_org_id;
DROP INDEX IF EXISTS public.idx_stakeholder_engagement_metrics_org_id;
DROP INDEX IF EXISTS public.idx_stakeholder_data_contributions_verified_by;
DROP INDEX IF EXISTS public.idx_stakeholder_data_contributions_esg_data_id;
DROP INDEX IF EXISTS public.idx_stakeholder_data_contributions_data_request_id;
DROP INDEX IF EXISTS public.idx_stakeholder_data_contributions_contributor_org_id;
DROP INDEX IF EXISTS public.idx_scheduled_notifications_template_id;
DROP INDEX IF EXISTS public.idx_scheduled_notifications_sender_id;
DROP INDEX IF EXISTS public.idx_scheduled_notifications_scheduled_for;
DROP INDEX IF EXISTS public.idx_scheduled_notifications_recipient_id;
DROP INDEX IF EXISTS public.idx_safeguarding_roles_user_role;
DROP INDEX IF EXISTS public.idx_safeguarding_roles_assigned_by;
DROP INDEX IF EXISTS public.idx_safe_space_verification_documents_verified_by;
DROP INDEX IF EXISTS public.idx_safe_space_verification_documents_user_id;
DROP INDEX IF EXISTS public.idx_safe_space_verification_documents_application_id;
DROP INDEX IF EXISTS public.idx_safe_space_sessions_requester_id;
DROP INDEX IF EXISTS public.idx_safe_space_sessions_paused_by;
DROP INDEX IF EXISTS public.idx_safe_space_sessions_helper_id;
DROP INDEX IF EXISTS public.idx_safe_space_reference_checks_application_id;
DROP INDEX IF EXISTS public.idx_safe_space_queue_requester_id;
DROP INDEX IF EXISTS public.idx_safe_space_messages_session_id;
DROP INDEX IF EXISTS public.idx_safe_space_helpers_user_id;
DROP INDEX IF EXISTS public.idx_safe_space_helper_training_progress_user_id;
DROP INDEX IF EXISTS public.idx_safe_space_helper_training_progress_module_id;
DROP INDEX IF EXISTS public.idx_safe_space_helper_applications_user_id;
DROP INDEX IF EXISTS public.idx_safe_space_helper_applications_reviewed_by;
DROP INDEX IF EXISTS public.idx_safe_space_flagged_keywords_created_by;
DROP INDEX IF EXISTS public.idx_safe_space_emergency_alerts_session_id;
DROP INDEX IF EXISTS public.idx_safe_space_emergency_alerts_message_id;
DROP INDEX IF EXISTS public.idx_safe_space_emergency_alerts_assigned_to;
DROP INDEX IF EXISTS public.idx_safe_space_audit_log_user_id;
...
DROP INDEX IF EXISTS public.idx_reports_reported_post_id;
DROP INDEX IF EXISTS public.idx_relive_stories_post_id;
DROP INDEX IF EXISTS public.idx_red_flags_user_id;
DROP INDEX IF EXISTS public.idx_red_flags_resolved_by;
DROP INDEX IF EXISTS public.idx_red_flags_flagged_by;
DROP INDEX IF EXISTS public.idx_recommendation_cache_user_id;
DROP INDEX IF EXISTS public.idx_rate_limit_buckets_user_id;
DROP INDEX IF EXISTS public.idx_questionnaire_responses_user_id;
DROP INDEX IF EXISTS public.idx_profiles_waitlist_approved_by;
...
DROP INDEX IF EXISTS public.idx_posts_user_import_source_external_id;
DROP INDEX IF EXISTS public.idx_posts_organization_id;
DROP INDEX IF EXISTS public.idx_posts_org_active;
DROP INDEX IF EXISTS public.idx_posts_location;
DROP INDEX IF EXISTS public.idx_posts_created_at;
DROP INDEX IF EXISTS public.idx_posts_category_created;
...
DROP INDEX IF EXISTS public.idx_posts_author_active;
...
DROP INDEX IF EXISTS public.idx_post_interactions_user_tags;
DROP INDEX IF EXISTS public.idx_post_interactions_user_post;
DROP INDEX IF EXISTS public.idx_post_interactions_user_id;
DROP INDEX IF EXISTS public.idx_post_interactions_post_type;
DROP INDEX IF EXISTS public.idx_post_interactions_post_id_created_at;
DROP INDEX IF EXISTS public.idx_post_interactions_post_id;
DROP INDEX IF EXISTS public.idx_post_interactions_parent_comment_id;
DROP INDEX IF EXISTS public.idx_post_interactions_organization_id;
DROP INDEX IF EXISTS public.idx_post_interactions_comments;
DROP INDEX IF EXISTS public.idx_post_interactions_comment_tags;
DROP INDEX IF EXISTS public.idx_points_configuration_updated_by;
DROP INDEX IF EXISTS public.idx_point_decay_log_user_id;
DROP INDEX IF EXISTS public.idx_platform_feedback_user_id;
DROP INDEX IF EXISTS public.idx_partnership_enquiries_status;
DROP INDEX IF EXISTS public.idx_partnership_enquiries_created_at;
DROP INDEX IF EXISTS public.idx_organizations_created_by;
DROP INDEX IF EXISTS public.idx_organization_verifications_verified_by;
DROP INDEX IF EXISTS public.idx_organization_settings_org_id;
DROP INDEX IF EXISTS public.idx_organization_reviews_reviewer_id;
DROP INDEX IF EXISTS public.idx_organization_preferences_organization_id;
DROP INDEX IF EXISTS public.idx_organization_members_verified_by;
...
DROP INDEX IF EXISTS public.idx_organization_esg_data_org_id;
DROP INDEX IF EXISTS public.idx_organization_esg_data_indicator_id;
DROP INDEX IF EXISTS public.idx_organization_esg_data_collected_by;
DROP INDEX IF EXISTS public.idx_org_verifications_org;
DROP INDEX IF EXISTS public.idx_org_trust_scores_org;
DROP INDEX IF EXISTS public.idx_org_reviews_rating;
DROP INDEX IF EXISTS public.idx_org_reviews_org;
DROP INDEX IF EXISTS public.idx_org_members_org_user;
DROP INDEX IF EXISTS public.idx_org_impact_metrics_org;
DROP INDEX IF EXISTS public.idx_org_followers_user;
DROP INDEX IF EXISTS public.idx_org_followers_org;
DROP INDEX IF EXISTS public.idx_org_activities_published;
DROP INDEX IF EXISTS public.idx_org_activities_org;
...
DROP INDEX IF EXISTS public.idx_notifications_recipient_id_created_at;
...
DROP INDEX IF EXISTS public.idx_notifications_grouped_with;
DROP INDEX IF EXISTS public.idx_notifications_group_key;
DROP INDEX IF EXISTS public.idx_notifications_delivery_status;
DROP INDEX IF EXISTS public.idx_notifications_created_at;
DROP INDEX IF EXISTS public.idx_notification_templates_type;
DROP INDEX IF EXISTS public.idx_notification_templates_created_by;
DROP INDEX IF EXISTS public.idx_notification_filters_user_id;
...
DROP INDEX IF EXISTS public.idx_notification_analytics_notification_id;
DROP INDEX IF EXISTS public.idx_notif_recip;
DROP INDEX IF EXISTS public.idx_newsletter_subscriptions_is_active;
...
DROP INDEX IF EXISTS public.idx_messages_sender_id_created_at;
DROP INDEX IF EXISTS public.idx_messages_sender_id;
DROP INDEX IF EXISTS public.idx_messages_recipient_unread;
DROP INDEX IF EXISTS public.idx_messages_recipient_sender;
DROP INDEX IF EXISTS public.idx_messages_recipient_id_created_at;
DROP INDEX IF EXISTS public.idx_messages_recipient_id;
DROP INDEX IF EXISTS public.idx_messages_read_at;
DROP INDEX IF EXISTS public.idx_messages_delivered_at;
DROP INDEX IF EXISTS public.idx_messages_created_at;
DROP INDEX IF EXISTS public.idx_message_access_log_user_id;
DROP INDEX IF EXISTS public.idx_message_access_log_message_id;
DROP INDEX IF EXISTS public.idx_materiality_assessments_org_id;
DROP INDEX IF EXISTS public.idx_materiality_assessments_indicator_id;
DROP INDEX IF EXISTS public.idx_materiality_assessments_created_by;
DROP INDEX IF EXISTS public.idx_language_detection_created;
DROP INDEX IF EXISTS public.idx_initiatives_progress;
DROP INDEX IF EXISTS public.idx_impact_metrics_user_id;
DROP INDEX IF EXISTS public.idx_impact_metrics_impact_score;
DROP INDEX IF EXISTS public.idx_impact_met_user;
DROP INDEX IF EXISTS public.idx_impact_goals_user_id;
DROP INDEX IF EXISTS public.idx_impact_goals_user_active;
DROP INDEX IF EXISTS public.idx_impact_activities_user_id;
DROP INDEX IF EXISTS public.idx_impact_activities_user_created;
DROP INDEX IF EXISTS public.idx_impact_activities_type_verified;
DROP INDEX IF EXISTS public.idx_impact_activities_skill_category;
DROP INDEX IF EXISTS public.idx_impact_activities_post_id;
DROP INDEX IF EXISTS public.idx_impact_activities_post_confirmation;
DROP INDEX IF EXISTS public.idx_impact_activities_organization_id;
DROP INDEX IF EXISTS public.idx_impact_activities_organization_confirmation;
DROP INDEX IF EXISTS public.idx_impact_activities_market_value;
DROP INDEX IF EXISTS public.idx_impact_activities_created_at;
DROP INDEX IF EXISTS public.idx_impact_activities_confirmed_by;
DROP INDEX IF EXISTS public.idx_impact_activities_confirmation_status;
DROP INDEX IF EXISTS public.idx_impact_act_user;
DROP INDEX IF EXISTS public.idx_helper_applications_submitted;
DROP INDEX IF EXISTS public.idx_helper_applications_status;
DROP INDEX IF EXISTS public.idx_help_completion_requests_status;
DROP INDEX IF EXISTS public.idx_help_completion_requests_requester_id;
DROP INDEX IF EXISTS public.idx_help_completion_requests_post_id;
DROP INDEX IF EXISTS public.idx_help_completion_requests_helper_id;
DROP INDEX IF EXISTS public.idx_groups_category;
DROP INDEX IF EXISTS public.idx_groups_admin_id;
...
DROP INDEX IF EXISTS public.idx_fraud_detection_log_user_id;
DROP INDEX IF EXISTS public.idx_fraud_detection_log_reviewer_id;
...
DROP INDEX IF EXISTS public.idx_evidence_submissions_verified_by;
DROP INDEX IF EXISTS public.idx_evidence_submissions_user_id;
DROP INDEX IF EXISTS public.idx_evidence_submissions_activity_id;
DROP INDEX IF EXISTS public.idx_esg_verification_audit_log_performed_by;
DROP INDEX IF EXISTS public.idx_esg_verification_audit_log_contribution_id;
DROP INDEX IF EXISTS public.idx_esg_targets_org_id;
DROP INDEX IF EXISTS public.idx_esg_targets_indicator_id;
DROP INDEX IF EXISTS public.idx_esg_targets_created_by;
DROP INDEX IF EXISTS public.idx_esg_risks_org_id;
DROP INDEX IF EXISTS public.idx_esg_reports_org_id;
DROP INDEX IF EXISTS public.idx_esg_reports_initiative_id;
DROP INDEX IF EXISTS public.idx_esg_recommendations_org_id;
DROP INDEX IF EXISTS public.idx_esg_initiatives_status;
DROP INDEX IF EXISTS public.idx_esg_initiatives_org_id;
DROP INDEX IF EXISTS public.idx_esg_indicators_framework_id;
DROP INDEX IF EXISTS public.idx_esg_goals_org_id;
DROP INDEX IF EXISTS public.idx_esg_goals_indicator_id;
DROP INDEX IF EXISTS public.idx_esg_data_requests_status;
DROP INDEX IF EXISTS public.idx_esg_data_requests_requested_from_org_id;
DROP INDEX IF EXISTS public.idx_esg_data_requests_org_id;
DROP INDEX IF EXISTS public.idx_esg_data_requests_initiative_id;
DROP INDEX IF EXISTS public.idx_esg_data_requests_indicator_id;
DROP INDEX IF EXISTS public.idx_esg_data_requests_framework_id;
DROP INDEX IF EXISTS public.idx_esg_data_entries_org_id;
DROP INDEX IF EXISTS public.idx_esg_data_entries_indicator_id;
DROP INDEX IF EXISTS public.idx_esg_compliance_reports_org_id;
DROP INDEX IF EXISTS public.idx_esg_compliance_reports_generated_by;
DROP INDEX IF EXISTS public.idx_esg_compliance_reports_framework_id;
DROP INDEX IF EXISTS public.idx_esg_compliance_reports_approved_by;
DROP INDEX IF EXISTS public.idx_esg_benchmarks_indicator_id;
DROP INDEX IF EXISTS public.idx_esg_announcements_org;
DROP INDEX IF EXISTS public.idx_employee_engagement_org_id;
DROP INDEX IF EXISTS public.idx_donors_user_id;
DROP INDEX IF EXISTS public.idx_donors_org_id;
...
DROP INDEX IF EXISTS public.idx_demo_activity_log_request_id;
DROP INDEX IF EXISTS public.idx_demo_activity_log_created_at;
DROP INDEX IF EXISTS public.idx_data_requests_status;
DROP INDEX IF EXISTS public.idx_csr_opportunities_status;
DROP INDEX IF EXISTS public.idx_csr_opportunities_post;
DROP INDEX IF EXISTS public.idx_csr_opportunities_org;
DROP INDEX IF EXISTS public.idx_csr_lead_tracking_org;
DROP INDEX IF EXISTS public.idx_csr_lead_tracking_created;
DROP INDEX IF EXISTS public.idx_csr_lead_tracking_action;
DROP INDEX IF EXISTS public.idx_csr_initiatives_org_id;
...
DROP INDEX IF EXISTS public.idx_conversation_participants_deleted;
DROP INDEX IF EXISTS public.idx_conversation_participants_conversation_id;
DROP INDEX IF EXISTS public.idx_conversation_participants_conv_user;
DROP INDEX IF EXISTS public.idx_contributions_verification_status;
DROP INDEX IF EXISTS public.idx_contributions_status;
DROP INDEX IF EXISTS public.idx_content_translations_lookup;
DROP INDEX IF EXISTS public.idx_content_translations_expires;
DROP INDEX IF EXISTS public.idx_content_reports_status;
DROP INDEX IF EXISTS public.idx_content_reports_reviewed_by;
DROP INDEX IF EXISTS public.idx_content_reports_reported_by;
DROP INDEX IF EXISTS public.idx_content_reports_content_owner_id;
DROP INDEX IF EXISTS public.idx_content_reports_content_id;
DROP INDEX IF EXISTS public.idx_content_reports_content;
DROP INDEX IF EXISTS public.idx_content_appeals_user_id;
DROP INDEX IF EXISTS public.idx_content_appeals_reviewed_by;
DROP INDEX IF EXISTS public.idx_content_appeals_report_id;
DROP INDEX IF EXISTS public.idx_contact_submissions_status;
DROP INDEX IF EXISTS public.idx_contact_submissions_created_at;
DROP INDEX IF EXISTS public.idx_connections_users;
DROP INDEX IF EXISTS public.idx_connections_status;
DROP INDEX IF EXISTS public.idx_connections_requester_status;
DROP INDEX IF EXISTS public.idx_connections_requester_id;
DROP INDEX IF EXISTS public.idx_connections_both_users;
DROP INDEX IF EXISTS public.idx_connections_addressee_status;
DROP INDEX IF EXISTS public.idx_connections_addressee_id;
DROP INDEX IF EXISTS public.idx_conn_req;
DROP INDEX IF EXISTS public.idx_conn_addr;
...
DROP INDEX IF EXISTS public.idx_carbon_footprint_data_organization_id;
DROP INDEX IF EXISTS public.idx_carbon_footprint_data_created_by;
DROP INDEX IF EXISTS public.idx_campaigns_status_date;
DROP INDEX IF EXISTS public.idx_campaigns_status;
DROP INDEX IF EXISTS public.idx_campaigns_end_date;
DROP INDEX IF EXISTS public.idx_campaigns_creator_status;
DROP INDEX IF EXISTS public.idx_campaigns_creator_id;
DROP INDEX IF EXISTS public.idx_campaigns_category;
DROP INDEX IF EXISTS public.idx_campaign_updates_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_updates_author_id;
DROP INDEX IF EXISTS public.idx_campaign_sponsorships_status;
DROP INDEX IF EXISTS public.idx_campaign_sponsorships_org;
DROP INDEX IF EXISTS public.idx_campaign_sponsorships_campaign;
DROP INDEX IF EXISTS public.idx_campaign_social_platform_date;
DROP INDEX IF EXISTS public.idx_campaign_social_metrics_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_promotions_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_predictions_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_participants_user_id;
DROP INDEX IF EXISTS public.idx_campaign_participants_user;
DROP INDEX IF EXISTS public.idx_campaign_participants_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_invitations_inviter_id;
DROP INDEX IF EXISTS public.idx_campaign_invitations_invitee_id;
DROP INDEX IF EXISTS public.idx_campaign_invitations_invitee_email;
DROP INDEX IF EXISTS public.idx_campaign_invitations_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_interactions_user_id;
DROP INDEX IF EXISTS public.idx_campaign_interactions_parent_id;
DROP INDEX IF EXISTS public.idx_campaign_interactions_organization_id;
DROP INDEX IF EXISTS public.idx_campaign_interactions_created_at;
DROP INDEX IF EXISTS public.idx_campaign_interactions_campaign_type;
DROP INDEX IF EXISTS public.idx_campaign_interactions_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_geographic_impact_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_geographic_country;
DROP INDEX IF EXISTS public.idx_campaign_engagement_user_id;
DROP INDEX IF EXISTS public.idx_campaign_engagement_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_engagement_campaign_action;
DROP INDEX IF EXISTS public.idx_campaign_donations_donor_id;
DROP INDEX IF EXISTS public.idx_campaign_donations_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_donations_campaign_created;
DROP INDEX IF EXISTS public.idx_campaign_analytics_date;
DROP INDEX IF EXISTS public.idx_campaign_analytics_campaign_id;
DROP INDEX IF EXISTS public.idx_campaign_analytics_campaign_date;
DROP INDEX IF EXISTS public.idx_camp_part_user;
DROP INDEX IF EXISTS public.idx_business_products_org_id;
DROP INDEX IF EXISTS public.idx_business_partnerships_org_id;
...
DROP INDEX IF EXISTS public.idx_badges_event_identifier;
DROP INDEX IF EXISTS public.idx_badges_campaign;
DROP INDEX IF EXISTS public.idx_badge_award_log_user;
DROP INDEX IF EXISTS public.idx_badge_award_log_status;
DROP INDEX IF EXISTS public.idx_badge_award_log_campaign;
DROP INDEX IF EXISTS public.idx_badge_award_log_badge;
DROP INDEX IF EXISTS public.idx_ai_rate_limits_user_endpoint;
DROP INDEX IF EXISTS public.idx_ai_endpoint_rate_limits_user_id;
DROP INDEX IF EXISTS public.idx_admin_roles_user_id;
DROP INDEX IF EXISTS public.idx_admin_roles_granted_by;
DROP INDEX IF EXISTS public.idx_admin_action_log_target_user_id;
DROP INDEX IF EXISTS public.idx_admin_action_log_created_at;
DROP INDEX IF EXISTS public.idx_admin_action_log_admin_id;
ALTER TABLE IF EXISTS ONLY public.white_label_purchases DROP CONSTRAINT IF EXISTS white_label_purchases_pkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_work_notifications DROP CONSTRAINT IF EXISTS volunteer_work_notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_opportunities DROP CONSTRAINT IF EXISTS volunteer_opportunities_pkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_interests DROP CONSTRAINT IF EXISTS volunteer_interests_post_id_volunteer_id_key;
ALTER TABLE IF EXISTS ONLY public.volunteer_interests DROP CONSTRAINT IF EXISTS volunteer_interests_pkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_applications DROP CONSTRAINT IF EXISTS volunteer_applications_pkey;
ALTER TABLE IF EXISTS ONLY public.volunteer_applications DROP CONSTRAINT IF EXISTS volunteer_applications_opportunity_id_user_id_key;
ALTER TABLE IF EXISTS ONLY public.verification_documents DROP CONSTRAINT IF EXISTS verification_documents_pkey;
ALTER TABLE IF EXISTS ONLY public.verification_document_audit DROP CONSTRAINT IF EXISTS verification_document_audit_pkey;
ALTER TABLE IF EXISTS ONLY public.user_verifications DROP CONSTRAINT IF EXISTS user_verifications_pkey;
ALTER TABLE IF EXISTS ONLY public.user_tutorial_progress DROP CONSTRAINT IF EXISTS user_tutorial_progress_pkey;
ALTER TABLE IF EXISTS ONLY public.user_subscriptions DROP CONSTRAINT IF EXISTS user_subscriptions_pkey;
ALTER TABLE IF EXISTS ONLY public.user_privacy_settings DROP CONSTRAINT IF EXISTS user_privacy_settings_user_id_key;
...
ALTER TABLE IF EXISTS ONLY public.user_preferences DROP CONSTRAINT IF EXISTS user_preferences_user_id_preference_type_preference_value_key;
ALTER TABLE IF EXISTS ONLY public.user_preferences DROP CONSTRAINT IF EXISTS user_preferences_pkey;
ALTER TABLE IF EXISTS ONLY public.user_language_preferences DROP CONSTRAINT IF EXISTS user_language_preferences_user_id_key;
ALTER TABLE IF EXISTS ONLY public.user_language_preferences DROP CONSTRAINT IF EXISTS user_language_preferences_pkey;
ALTER TABLE IF EXISTS ONLY public.user_interaction_scores DROP CONSTRAINT IF EXISTS user_interaction_scores_user_id_target_user_id_target_post__key;
ALTER TABLE IF EXISTS ONLY public.user_interaction_scores DROP CONSTRAINT IF EXISTS user_interaction_scores_pkey;
ALTER TABLE IF EXISTS ONLY public.user_challenge_progress DROP CONSTRAINT IF EXISTS user_challenge_progress_user_id_challenge_id_key;
ALTER TABLE IF EXISTS ONLY public.user_challenge_progress DROP CONSTRAINT IF EXISTS user_challenge_progress_pkey;
ALTER TABLE IF EXISTS ONLY public.user_blocks DROP CONSTRAINT IF EXISTS user_blocks_pkey;
ALTER TABLE IF EXISTS ONLY public.user_blocks DROP CONSTRAINT IF EXISTS user_blocks_blocker_id_blocked_id_key;
...
ALTER TABLE IF EXISTS ONLY public.url_previews DROP CONSTRAINT IF EXISTS url_previews_url_key;
ALTER TABLE IF EXISTS ONLY public.url_previews DROP CONSTRAINT IF EXISTS url_previews_pkey;
ALTER TABLE IF EXISTS ONLY public.typing_indicators DROP CONSTRAINT IF EXISTS typing_indicators_user_id_conversation_partner_id_key;
ALTER TABLE IF EXISTS ONLY public.typing_indicators DROP CONSTRAINT IF EXISTS typing_indicators_pkey;
ALTER TABLE IF EXISTS ONLY public.tutorial_preferences DROP CONSTRAINT IF EXISTS tutorial_preferences_user_id_key;
ALTER TABLE IF EXISTS ONLY public.tutorial_preferences DROP CONSTRAINT IF EXISTS tutorial_preferences_pkey;
ALTER TABLE IF EXISTS ONLY public.trust_score_history DROP CONSTRAINT IF EXISTS trust_score_history_pkey;
ALTER TABLE IF EXISTS ONLY public.trust_domains DROP CONSTRAINT IF EXISTS trust_domains_user_id_domain_key;
ALTER TABLE IF EXISTS ONLY public.trust_domains DROP CONSTRAINT IF EXISTS trust_domains_pkey;
ALTER TABLE IF EXISTS ONLY public.support_actions DROP CONSTRAINT IF EXISTS support_actions_pkey;
ALTER TABLE IF EXISTS ONLY public.subscription_plans DROP CONSTRAINT IF EXISTS subscription_plans_pkey;
ALTER TABLE IF EXISTS ONLY public.subscription_admin_actions DROP CONSTRAINT IF EXISTS subscription_admin_actions_pkey;
ALTER TABLE IF EXISTS ONLY public.story_updates DROP CONSTRAINT IF EXISTS story_updates_pkey;
ALTER TABLE IF EXISTS ONLY public.story_participants DROP CONSTRAINT IF EXISTS story_participants_post_id_user_id_key;
ALTER TABLE IF EXISTS ONLY public.story_participants DROP CONSTRAINT IF EXISTS story_participants_pkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_groups DROP CONSTRAINT IF EXISTS stakeholder_groups_pkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_engagement_metrics DROP CONSTRAINT IF EXISTS stakeholder_engagement_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.stakeholder_data_contributions DROP CONSTRAINT IF EXISTS stakeholder_data_contributions_pkey;
ALTER TABLE IF EXISTS ONLY public.skill_categories DROP CONSTRAINT IF EXISTS skill_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.security_audit_log DROP CONSTRAINT IF EXISTS security_audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.seasonal_challenges DROP CONSTRAINT IF EXISTS seasonal_challenges_pkey;
ALTER TABLE IF EXISTS ONLY public.scheduled_notifications DROP CONSTRAINT IF EXISTS scheduled_notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.safeguarding_roles DROP CONSTRAINT IF EXISTS safeguarding_roles_user_id_role_key;
ALTER TABLE IF EXISTS ONLY public.safeguarding_roles DROP CONSTRAINT IF EXISTS safeguarding_roles_unique_lead_per_user;
ALTER TABLE IF EXISTS ONLY public.safeguarding_roles DROP CONSTRAINT IF EXISTS safeguarding_roles_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_verification_documents DROP CONSTRAINT IF EXISTS safe_space_verification_documents_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_training_modules DROP CONSTRAINT IF EXISTS safe_space_training_modules_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_sessions DROP CONSTRAINT IF EXISTS safe_space_sessions_session_token_key;
ALTER TABLE IF EXISTS ONLY public.safe_space_sessions DROP CONSTRAINT IF EXISTS safe_space_sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_reference_checks DROP CONSTRAINT IF EXISTS safe_space_reference_checks_verification_token_key;
ALTER TABLE IF EXISTS ONLY public.safe_space_reference_checks DROP CONSTRAINT IF EXISTS safe_space_reference_checks_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_queue DROP CONSTRAINT IF EXISTS safe_space_queue_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_messages DROP CONSTRAINT IF EXISTS safe_space_messages_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helpers DROP CONSTRAINT IF EXISTS safe_space_helpers_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_training_progress DROP CONSTRAINT IF EXISTS safe_space_helper_training_progress_user_id_module_id_key;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_training_progress DROP CONSTRAINT IF EXISTS safe_space_helper_training_progress_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_helper_applications DROP CONSTRAINT IF EXISTS safe_space_helper_applications_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_flagged_keywords DROP CONSTRAINT IF EXISTS safe_space_flagged_keywords_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_flagged_keywords DROP CONSTRAINT IF EXISTS safe_space_flagged_keywords_keyword_key;
ALTER TABLE IF EXISTS ONLY public.safe_space_emergency_alerts DROP CONSTRAINT IF EXISTS safe_space_emergency_alerts_pkey;
ALTER TABLE IF EXISTS ONLY public.safe_space_audit_log DROP CONSTRAINT IF EXISTS safe_space_audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.reports DROP CONSTRAINT IF EXISTS reports_pkey;
ALTER TABLE IF EXISTS ONLY public.relive_stories DROP CONSTRAINT IF EXISTS relive_stories_post_id_key;
ALTER TABLE IF EXISTS ONLY public.relive_stories DROP CONSTRAINT IF EXISTS relive_stories_pkey;
ALTER TABLE IF EXISTS ONLY public.red_flags DROP CONSTRAINT IF EXISTS red_flags_pkey;
ALTER TABLE IF EXISTS ONLY public.recommendation_cache DROP CONSTRAINT IF EXISTS recommendation_cache_user_id_recommendation_type_target_id_key;
ALTER TABLE IF EXISTS ONLY public.recommendation_cache DROP CONSTRAINT IF EXISTS recommendation_cache_pkey;
ALTER TABLE IF EXISTS ONLY public.rate_limit_buckets DROP CONSTRAINT IF EXISTS rate_limit_buckets_user_id_bucket_type_key;
ALTER TABLE IF EXISTS ONLY public.rate_limit_buckets DROP CONSTRAINT IF EXISTS rate_limit_buckets_pkey;
ALTER TABLE IF EXISTS ONLY public.questionnaire_responses DROP CONSTRAINT IF EXISTS questionnaire_responses_user_id_unique;
ALTER TABLE IF EXISTS ONLY public.questionnaire_responses DROP CONSTRAINT IF EXISTS questionnaire_responses_pkey;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.posts DROP CONSTRAINT IF EXISTS posts_pkey;
ALTER TABLE IF EXISTS ONLY public.post_reactions DROP CONSTRAINT IF EXISTS post_reactions_post_id_user_id_reaction_type_key;
ALTER TABLE IF EXISTS ONLY public.post_reactions DROP CONSTRAINT IF EXISTS post_reactions_pkey;
ALTER TABLE IF EXISTS ONLY public.post_interactions DROP CONSTRAINT IF EXISTS post_interactions_pkey;
ALTER TABLE IF EXISTS ONLY public.points_configuration DROP CONSTRAINT IF EXISTS points_configuration_pkey;
ALTER TABLE IF EXISTS ONLY public.points_configuration DROP CONSTRAINT IF EXISTS points_configuration_config_key_key;
ALTER TABLE IF EXISTS ONLY public.point_redemptions DROP CONSTRAINT IF EXISTS point_redemptions_pkey;
ALTER TABLE IF EXISTS ONLY public.point_decay_log DROP CONSTRAINT IF EXISTS point_decay_log_pkey;
ALTER TABLE IF EXISTS ONLY public.platform_payments DROP CONSTRAINT IF EXISTS platform_payments_pkey;
ALTER TABLE IF EXISTS ONLY public.platform_payments DROP CONSTRAINT IF EXISTS platform_payments_payment_reference_key;
ALTER TABLE IF EXISTS ONLY public.platform_feedback DROP CONSTRAINT IF EXISTS platform_feedback_pkey;
ALTER TABLE IF EXISTS ONLY public.payment_references DROP CONSTRAINT IF EXISTS payment_references_reference_code_key;
ALTER TABLE IF EXISTS ONLY public.payment_references DROP CONSTRAINT IF EXISTS payment_references_pkey;
ALTER TABLE IF EXISTS ONLY public.partnership_enquiries DROP CONSTRAINT IF EXISTS partnership_enquiries_pkey;
ALTER TABLE IF EXISTS ONLY public.organizations DROP CONSTRAINT IF EXISTS organizations_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_verifications DROP CONSTRAINT IF EXISTS organization_verifications_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_trust_scores DROP CONSTRAINT IF EXISTS organization_trust_scores_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_trust_scores DROP CONSTRAINT IF EXISTS organization_trust_scores_organization_id_calculated_at_key;
ALTER TABLE IF EXISTS ONLY public.organization_team_members DROP CONSTRAINT IF EXISTS organization_team_members_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_team_members DROP CONSTRAINT IF EXISTS organization_team_members_organization_id_user_id_key;
...
ALTER TABLE IF EXISTS ONLY public.organization_reviews DROP CONSTRAINT IF EXISTS organization_reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_reviews DROP CONSTRAINT IF EXISTS organization_reviews_organization_id_reviewer_id_key;
ALTER TABLE IF EXISTS ONLY public.organization_preferences DROP CONSTRAINT IF EXISTS organization_preferences_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_members DROP CONSTRAINT IF EXISTS organization_members_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_members DROP CONSTRAINT IF EXISTS organization_members_organization_id_user_id_role_key;
ALTER TABLE IF EXISTS ONLY public.organization_invitations DROP CONSTRAINT IF EXISTS organization_invitations_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_invitations DROP CONSTRAINT IF EXISTS organization_invitations_organization_id_email_key;
ALTER TABLE IF EXISTS ONLY public.organization_impact_metrics DROP CONSTRAINT IF EXISTS organization_impact_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_impact_metrics DROP CONSTRAINT IF EXISTS organization_impact_metrics_organization_id_key;
ALTER TABLE IF EXISTS ONLY public.organization_followers DROP CONSTRAINT IF EXISTS organization_followers_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_followers DROP CONSTRAINT IF EXISTS organization_followers_organization_id_follower_id_key;
ALTER TABLE IF EXISTS ONLY public.organization_esg_data DROP CONSTRAINT IF EXISTS organization_esg_data_pkey;
ALTER TABLE IF EXISTS ONLY public.organization_esg_data DROP CONSTRAINT IF EXISTS organization_esg_data_organization_id_indicator_id_reportin_key;
...
ALTER TABLE IF EXISTS ONLY public.notification_filters DROP CONSTRAINT IF EXISTS notification_filters_pkey;
ALTER TABLE IF EXISTS ONLY public.notification_delivery_log DROP CONSTRAINT IF EXISTS notification_delivery_log_pkey;
ALTER TABLE IF EXISTS ONLY public.notification_analytics DROP CONSTRAINT IF EXISTS notification_analytics_pkey;
...
ALTER TABLE IF EXISTS ONLY public.message_access_log DROP CONSTRAINT IF EXISTS message_access_log_pkey;
ALTER TABLE IF EXISTS ONLY public.materiality_assessments DROP CONSTRAINT IF EXISTS materiality_assessments_pkey;
ALTER TABLE IF EXISTS ONLY public.materiality_assessments DROP CONSTRAINT IF EXISTS materiality_assessments_organization_id_assessment_year_ind_key;
ALTER TABLE IF EXISTS ONLY public.language_detection_cache DROP CONSTRAINT IF EXISTS language_detection_cache_pkey;
ALTER TABLE IF EXISTS ONLY public.impact_metrics DROP CONSTRAINT IF EXISTS impact_metrics_user_id_key;
ALTER TABLE IF EXISTS ONLY public.impact_metrics DROP CONSTRAINT IF EXISTS impact_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.impact_goals DROP CONSTRAINT IF EXISTS impact_goals_pkey;
ALTER TABLE IF EXISTS ONLY public.impact_activities DROP CONSTRAINT IF EXISTS impact_activities_pkey;
ALTER TABLE IF EXISTS ONLY public.help_completion_requests DROP CONSTRAINT IF EXISTS help_completion_requests_pkey;
...
ALTER TABLE IF EXISTS ONLY public.grants DROP CONSTRAINT IF EXISTS grants_pkey;
ALTER TABLE IF EXISTS ONLY public.fraud_detection_log DROP CONSTRAINT IF EXISTS fraud_detection_log_pkey;
ALTER TABLE IF EXISTS ONLY public.evidence_submissions DROP CONSTRAINT IF EXISTS evidence_submissions_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_verification_audit_log DROP CONSTRAINT IF EXISTS esg_verification_audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_targets DROP CONSTRAINT IF EXISTS esg_targets_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_risks DROP CONSTRAINT IF EXISTS esg_risks_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_reports DROP CONSTRAINT IF EXISTS esg_reports_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_report_versions DROP CONSTRAINT IF EXISTS esg_report_versions_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_recommendations DROP CONSTRAINT IF EXISTS esg_recommendations_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_initiatives DROP CONSTRAINT IF EXISTS esg_initiatives_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_initiative_templates DROP CONSTRAINT IF EXISTS esg_initiative_templates_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_indicators DROP CONSTRAINT IF EXISTS esg_indicators_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_goals DROP CONSTRAINT IF EXISTS esg_goals_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_frameworks DROP CONSTRAINT IF EXISTS esg_frameworks_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_frameworks DROP CONSTRAINT IF EXISTS esg_frameworks_code_key;
ALTER TABLE IF EXISTS ONLY public.esg_data_requests DROP CONSTRAINT IF EXISTS esg_data_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_data_entries DROP CONSTRAINT IF EXISTS esg_data_entries_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_compliance_reports DROP CONSTRAINT IF EXISTS esg_compliance_reports_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_benchmarks DROP CONSTRAINT IF EXISTS esg_benchmarks_pkey;
ALTER TABLE IF EXISTS ONLY public.esg_announcements DROP CONSTRAINT IF EXISTS esg_announcements_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_engagement DROP CONSTRAINT IF EXISTS employee_engagement_pkey;
ALTER TABLE IF EXISTS ONLY public.donors DROP CONSTRAINT IF EXISTS donors_pkey;
ALTER TABLE IF EXISTS ONLY public.donors DROP CONSTRAINT IF EXISTS donors_organization_id_email_key;
ALTER TABLE IF EXISTS ONLY public.demo_requests DROP CONSTRAINT IF EXISTS demo_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.demo_request_activity_log DROP CONSTRAINT IF EXISTS demo_request_activity_log_pkey;
ALTER TABLE IF EXISTS ONLY public.csr_opportunities DROP CONSTRAINT IF EXISTS csr_opportunities_pkey;
ALTER TABLE IF EXISTS ONLY public.csr_lead_tracking DROP CONSTRAINT IF EXISTS csr_lead_tracking_pkey;
ALTER TABLE IF EXISTS ONLY public.csr_initiatives DROP CONSTRAINT IF EXISTS csr_initiatives_pkey;
ALTER TABLE IF EXISTS ONLY public.corporate_partnerships DROP CONSTRAINT IF EXISTS corporate_partnerships_pkey;
...
ALTER TABLE IF EXISTS ONLY public.content_translations DROP CONSTRAINT IF EXISTS content_translations_content_id_content_type_target_languag_key;
ALTER TABLE IF EXISTS ONLY public.content_reports DROP CONSTRAINT IF EXISTS content_reports_pkey;
ALTER TABLE IF EXISTS ONLY public.content_appeals DROP CONSTRAINT IF EXISTS content_appeals_pkey;
ALTER TABLE IF EXISTS ONLY public.contact_submissions DROP CONSTRAINT IF EXISTS contact_submissions_pkey;
ALTER TABLE IF EXISTS ONLY public.connections DROP CONSTRAINT IF EXISTS connections_requester_id_addressee_id_key;
...
ALTER TABLE IF EXISTS ONLY public.comment_likes DROP CONSTRAINT IF EXISTS comment_likes_comment_id_user_id_key;
ALTER TABLE IF EXISTS ONLY public.carbon_footprint_data DROP CONSTRAINT IF EXISTS carbon_footprint_data_pkey;
...
ALTER TABLE IF EXISTS ONLY public.campaign_sponsorships DROP CONSTRAINT IF EXISTS campaign_sponsorships_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_social_metrics DROP CONSTRAINT IF EXISTS campaign_social_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_promotions DROP CONSTRAINT IF EXISTS campaign_promotions_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_predictions DROP CONSTRAINT IF EXISTS campaign_predictions_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_participants DROP CONSTRAINT IF EXISTS campaign_participants_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_invitations DROP CONSTRAINT IF EXISTS campaign_invitations_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_interactions DROP CONSTRAINT IF EXISTS campaign_interactions_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_geographic_impact DROP CONSTRAINT IF EXISTS campaign_geographic_impact_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_engagement DROP CONSTRAINT IF EXISTS campaign_engagement_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_donations DROP CONSTRAINT IF EXISTS campaign_donations_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_detailed_analytics DROP CONSTRAINT IF EXISTS campaign_detailed_analytics_pkey;
ALTER TABLE IF EXISTS ONLY public.campaign_detailed_analytics DROP CONSTRAINT IF EXISTS campaign_detailed_analytics_campaign_id_date_key;
ALTER TABLE IF EXISTS ONLY public.campaign_analytics DROP CONSTRAINT IF EXISTS campaign_analytics_pkey;
ALTER TABLE IF EXISTS ONLY public.business_products DROP CONSTRAINT IF EXISTS business_products_pkey;
ALTER TABLE IF EXISTS ONLY public.business_partnerships DROP CONSTRAINT IF EXISTS business_partnerships_pkey;
...
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_user_id_badge_id_key;
ALTER TABLE IF EXISTS ONLY public.badge_award_log DROP CONSTRAINT IF EXISTS badge_award_log_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_endpoint_rate_limits DROP CONSTRAINT IF EXISTS ai_endpoint_rate_limits_user_id_endpoint_name_window_start_key;
ALTER TABLE IF EXISTS ONLY public.ai_endpoint_rate_limits DROP CONSTRAINT IF EXISTS ai_endpoint_rate_limits_pkey;
ALTER TABLE IF EXISTS ONLY public.advertising_bookings DROP CONSTRAINT IF EXISTS advertising_bookings_pkey;
ALTER TABLE IF EXISTS ONLY public.admin_roles DROP CONSTRAINT IF EXISTS admin_roles_user_id_role_key;
...
DROP TABLE IF EXISTS public.white_label_purchases;
DROP TABLE IF EXISTS public.volunteer_work_notifications;
DROP TABLE IF EXISTS public.volunteer_opportunities;
DROP TABLE IF EXISTS public.volunteer_interests;
DROP TABLE IF EXISTS public.volunteer_applications;
DROP TABLE IF EXISTS public.verification_documents;
DROP TABLE IF EXISTS public.verification_document_audit;
DROP TABLE IF EXISTS public.user_verifications;
DROP TABLE IF EXISTS public.user_tutorial_progress;
...
DROP TABLE IF EXISTS public.user_interaction_scores;
...
DROP TABLE IF EXISTS public.tutorial_preferences;
DROP TABLE IF EXISTS public.trust_score_history;
DROP TABLE IF EXISTS public.trust_domains;
DROP TABLE IF EXISTS public.support_actions;
DROP TABLE IF EXISTS public.subscription_plans;
DROP TABLE IF EXISTS public.subscription_admin_actions;
DROP TABLE IF EXISTS public.story_updates;
DROP TABLE IF EXISTS public.story_participants;
DROP TABLE IF EXISTS public.stakeholder_groups;
DROP TABLE IF EXISTS public.stakeholder_engagement_metrics;
DROP TABLE IF EXISTS public.stakeholder_data_contributions;
DROP TABLE IF EXISTS public.skill_categories;
DROP TABLE IF EXISTS public.security_audit_log;
DROP TABLE IF EXISTS public.seasonal_challenges;
DROP TABLE IF EXISTS public.scheduled_notifications;
DROP TABLE IF EXISTS public.safeguarding_roles;
DROP TABLE IF EXISTS public.safe_space_verification_documents;
DROP TABLE IF EXISTS public.safe_space_training_modules;
DROP TABLE IF EXISTS public.safe_space_sessions;
DROP TABLE IF EXISTS public.safe_space_reference_checks;
DROP TABLE IF EXISTS public.safe_space_queue;
DROP TABLE IF EXISTS public.safe_space_messages;
DROP TABLE IF EXISTS public.safe_space_helpers;
DROP TABLE IF EXISTS public.safe_space_helper_training_progress;
DROP TABLE IF EXISTS public.safe_space_helper_applications;
DROP TABLE IF EXISTS public.safe_space_flagged_keywords;
DROP TABLE IF EXISTS public.safe_space_emergency_alerts;
DROP TABLE IF EXISTS public.safe_space_audit_log;
DROP TABLE IF EXISTS public.reports;
DROP TABLE IF EXISTS public.relive_stories;
DROP TABLE IF EXISTS public.red_flags;
...
DROP TABLE IF EXISTS public.points_configuration;
DROP TABLE IF EXISTS public.point_redemptions;
DROP TABLE IF EXISTS public.point_decay_log;
DROP TABLE IF EXISTS public.platform_payments;
DROP TABLE IF EXISTS public.platform_feedback;
DROP TABLE IF EXISTS public.payment_references;
DROP TABLE IF EXISTS public.partnership_enquiries;
DROP TABLE IF EXISTS public.organizations;
DROP TABLE IF EXISTS public.organization_verifications;
DROP TABLE IF EXISTS public.organization_trust_scores;
DROP TABLE IF EXISTS public.organization_team_members;
DROP TABLE IF EXISTS public.organization_settings;
DROP TABLE IF EXISTS public.organization_reviews;
DROP TABLE IF EXISTS public.organization_preferences;
DROP TABLE IF EXISTS public.organization_members;
DROP TABLE IF EXISTS public.organization_invitations;
DROP TABLE IF EXISTS public.organization_impact_metrics;
DROP TABLE IF EXISTS public.organization_followers;
DROP TABLE IF EXISTS public.organization_esg_data;
DROP TABLE IF EXISTS public.organization_activities;
DROP TABLE IF EXISTS public.notifications;
DROP TABLE IF EXISTS public.notification_templates;
DROP TABLE IF EXISTS public.notification_filters;
DROP TABLE IF EXISTS public.notification_delivery_log;
DROP TABLE IF EXISTS public.notification_analytics;
DROP TABLE IF EXISTS public.newsletter_subscriptions;
DROP TABLE IF EXISTS public.newsletter_subscribers;
DROP TABLE IF EXISTS public.messages;
DROP TABLE IF EXISTS public.message_access_log;
DROP TABLE IF EXISTS public.materiality_assessments;
DROP TABLE IF EXISTS public.language_detection_cache;
DROP TABLE IF EXISTS public.impact_metrics;
DROP TABLE IF EXISTS public.impact_goals;
DROP TABLE IF EXISTS public.impact_activities;
DROP TABLE IF EXISTS public.help_completion_requests;
DROP TABLE IF EXISTS public.groups;
DROP TABLE IF EXISTS public.group_members;
DROP TABLE IF EXISTS public.grants;
DROP TABLE IF EXISTS public.fraud_detection_log;
DROP TABLE IF EXISTS public.evidence_submissions;
DROP TABLE IF EXISTS public.esg_verification_audit_log;
DROP TABLE IF EXISTS public.esg_targets;
DROP TABLE IF EXISTS public.esg_risks;
DROP TABLE IF EXISTS public.esg_reports;
DROP TABLE IF EXISTS public.esg_report_versions;
DROP TABLE IF EXISTS public.esg_recommendations;
DROP TABLE IF EXISTS public.esg_initiatives;
DROP TABLE IF EXISTS public.esg_initiative_templates;
DROP TABLE IF EXISTS public.esg_indicators;
DROP TABLE IF EXISTS public.esg_goals;
DROP TABLE IF EXISTS public.esg_frameworks;
DROP TABLE IF EXISTS public.esg_data_requests;
DROP TABLE IF EXISTS public.esg_data_entries;
DROP TABLE IF EXISTS public.esg_compliance_reports;
DROP TABLE IF EXISTS public.esg_benchmarks;
DROP TABLE IF EXISTS public.esg_announcements;
DROP TABLE IF EXISTS public.employee_engagement;
DROP TABLE IF EXISTS public.donors;
DROP TABLE IF EXISTS public.demo_requests;
DROP TABLE IF EXISTS public.demo_request_activity_log;
DROP TABLE IF EXISTS public.csr_opportunities;
DROP TABLE IF EXISTS public.csr_lead_tracking;
DROP TABLE IF EXISTS public.csr_initiatives;
DROP TABLE IF EXISTS public.corporate_partnerships;
...
DROP TABLE IF EXISTS public.content_appeals;
...
DROP TABLE IF EXISTS public.carbon_footprint_data;
DROP TABLE IF EXISTS public.campaigns;
DROP TABLE IF EXISTS public.campaign_updates;
DROP TABLE IF EXISTS public.campaign_sponsorships;
DROP TABLE IF EXISTS public.campaign_social_metrics;
DROP TABLE IF EXISTS public.campaign_promotions;
DROP TABLE IF EXISTS public.campaign_predictions;
DROP TABLE IF EXISTS public.campaign_participants;
DROP TABLE IF EXISTS public.campaign_invitations;
DROP TABLE IF EXISTS public.campaign_interactions;
DROP TABLE IF EXISTS public.campaign_geographic_impact;
DROP TABLE IF EXISTS public.campaign_engagement;
DROP TABLE IF EXISTS public.campaign_donations;
DROP TABLE IF EXISTS public.campaign_detailed_analytics;
DROP TABLE IF EXISTS public.campaign_analytics;
DROP TABLE IF EXISTS public.business_products;
DROP TABLE IF EXISTS public.business_partnerships;
DROP TABLE IF EXISTS public.blog_posts;
DROP TABLE IF EXISTS public.blog_categories;
DROP TABLE IF EXISTS public.badges;
DROP TABLE IF EXISTS public.badge_award_log;
DROP TABLE IF EXISTS public.ai_endpoint_rate_limits;
DROP TABLE IF EXISTS public.advertising_bookings;
DROP TABLE IF EXISTS public.admin_roles;
DROP TABLE IF EXISTS public.admin_action_log;
DROP FUNCTION IF EXISTS public.validate_organization_invitation(token_input text);
DROP FUNCTION IF EXISTS public.update_updated_at_column();
DROP FUNCTION IF EXISTS public.update_subscription_updated_at();
DROP FUNCTION IF EXISTS public.update_safe_space_updated_at();
DROP FUNCTION IF EXISTS public.update_profile_updated_at();
DROP FUNCTION IF EXISTS public.update_privacy_settings_updated_at();
DROP FUNCTION IF EXISTS public.update_organization_impact_metrics();
DROP FUNCTION IF EXISTS public.update_market_value_metrics();
DROP FUNCTION IF EXISTS public.update_helper_session_count();
DROP FUNCTION IF EXISTS public.update_goal_progress();
DROP FUNCTION IF EXISTS public.update_esg_initiatives_updated_at();
DROP FUNCTION IF EXISTS public.update_campaign_amount(campaign_uuid uuid, donation_amount numeric);
DROP FUNCTION IF EXISTS public.toggle_post_reaction(target_post_id uuid, target_reaction_type text);
DROP FUNCTION IF EXISTS public.toggle_comment_like(target_comment_id uuid);
DROP FUNCTION IF EXISTS public.sync_questionnaire_to_profile();
DROP FUNCTION IF EXISTS public.sync_profile_email();
DROP FUNCTION IF EXISTS public.sync_helper_verification_status();
DROP FUNCTION IF EXISTS public.sync_approved_helper_application();
DROP FUNCTION IF EXISTS public.render_notification_template(template_id_input uuid, variables jsonb);
DROP FUNCTION IF EXISTS public.recalculate_trust_score_on_verification();
DROP FUNCTION IF EXISTS public.process_scheduled_notifications();
DROP FUNCTION IF EXISTS public.process_safe_space_queue();
DROP FUNCTION IF EXISTS public.prevent_duplicate_connections();
DROP FUNCTION IF EXISTS public.p2p_messages_broadcast_trigger();
DROP FUNCTION IF EXISTS public.on_helper_availability_change();
DROP FUNCTION IF EXISTS public.notify_volunteer_work_status();
DROP FUNCTION IF EXISTS public.notify_volunteer_work_logged();
DROP FUNCTION IF EXISTS public.notify_new_demo_request();
DROP FUNCTION IF EXISTS public.notify_feedback_status_change();
DROP FUNCTION IF EXISTS public.notify_esg_milestone();
DROP FUNCTION IF EXISTS public.notify_contribution_status();
DROP FUNCTION IF EXISTS public.notify_badge_award();
DROP FUNCTION IF EXISTS public.match_safe_space_helper(p_requester_id uuid, p_issue_category text, p_urgency_level text);
DROP FUNCTION IF EXISTS public.log_verification_action();
DROP FUNCTION IF EXISTS public.log_message_access();
DROP FUNCTION IF EXISTS public.log_esg_data_access();
DROP FUNCTION IF EXISTS public.is_user_admin(user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_safeguarding_staff(_user_id uuid);
DROP FUNCTION IF EXISTS public.is_organization_member(org_id uuid, user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_organization_admin(org_id uuid, user_id uuid);
DROP FUNCTION IF EXISTS public.is_org_member(org_uuid uuid, user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_org_admin(org_uuid uuid, user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_group_public(p_group_id uuid);
DROP FUNCTION IF EXISTS public.is_group_member(p_user_id uuid, p_group_id uuid);
DROP FUNCTION IF EXISTS public.is_group_admin(p_user_id uuid, p_group_id uuid);
DROP FUNCTION IF EXISTS public.is_campaign_participant(campaign_uuid uuid, user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_campaign_creator(campaign_uuid uuid, user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_admin_raw(user_uuid uuid);
DROP FUNCTION IF EXISTS public.is_admin(user_uuid uuid);
DROP FUNCTION IF EXISTS public.increment_report_download();
DROP FUNCTION IF EXISTS public.increment_badge_award_count();
DROP FUNCTION IF EXISTS public.has_white_label_access(user_id uuid);
DROP FUNCTION IF EXISTS public.has_safeguarding_role(_user_id uuid, _role public.safeguarding_role);
DROP FUNCTION IF EXISTS public.handle_updated_at();
DROP FUNCTION IF EXISTS public.handle_new_user();
DROP FUNCTION IF EXISTS public.handle_language_prefs_updated_at();
DROP FUNCTION IF EXISTS public.handle_help_completion();
DROP FUNCTION IF EXISTS public.handle_help_approval();
DROP FUNCTION IF EXISTS public.handle_enhanced_help_approval();
DROP FUNCTION IF EXISTS public.group_similar_notifications(p_user_id uuid, p_type text, p_time_window interval);
DROP FUNCTION IF EXISTS public.get_volunteer_work_recipient(activity_id uuid);
DROP FUNCTION IF EXISTS public.get_user_total_points(target_user_id uuid);
DROP FUNCTION IF EXISTS public.get_user_organizations(target_user_id uuid);
DROP FUNCTION IF EXISTS public.get_user_conversations(target_user_id uuid);
DROP FUNCTION IF EXISTS public.get_post_reaction_counts(target_post_id uuid);
DROP FUNCTION IF EXISTS public.get_post_comments(target_post_id uuid);
DROP FUNCTION IF EXISTS public.get_or_create_conversation(user1_id uuid, user2_id uuid);
DROP FUNCTION IF EXISTS public.get_notification_analytics(p_user_id uuid, p_days_back integer);
DROP FUNCTION IF EXISTS public.get_feed_with_stats(p_user_id uuid, p_organization_id uuid, p_limit integer, p_offset integer);
DROP FUNCTION IF EXISTS public.get_esg_compliance_status(org_id uuid);
DROP FUNCTION IF EXISTS public.get_esg_access_level(user_id uuid);
DROP FUNCTION IF EXISTS public.get_donor_statistics(org_id uuid);
DROP FUNCTION IF EXISTS public.get_conversations_optimized(p_user_id uuid);
DROP FUNCTION IF EXISTS public.generate_user_recommendations_with_orgs(target_user_id uuid);
DROP FUNCTION IF EXISTS public.generate_user_recommendations(target_user_id uuid);
DROP FUNCTION IF EXISTS public.find_nearby_users(user_lat numeric, user_lon numeric, radius_km numeric, limit_count integer);
DROP FUNCTION IF EXISTS public.find_nearby_posts(user_lat numeric, user_lon numeric, radius_km numeric, limit_count integer, offset_count integer);
DROP FUNCTION IF EXISTS public.expire_typing_indicator();
DROP FUNCTION IF EXISTS public.encrypt_message(message_text text);
DROP FUNCTION IF EXISTS public.detect_fraud_patterns(target_user_id uuid);
DROP FUNCTION IF EXISTS public.decrypt_message(encrypted_data bytea);
DROP FUNCTION IF EXISTS public.create_relive_story_on_completion();
DROP FUNCTION IF EXISTS public.create_default_goals_for_user(target_user_id uuid);
DROP FUNCTION IF EXISTS public.confirm_volunteer_work(activity_id uuid, confirm_status text, rejection_note text);
DROP FUNCTION IF EXISTS public.cleanup_old_rate_limits();
DROP FUNCTION IF EXISTS public.cleanup_old_message_logs();
DROP FUNCTION IF EXISTS public.cleanup_expired_safe_space_messages();
DROP FUNCTION IF EXISTS public.check_team_member_limit(org_id uuid);
DROP FUNCTION IF EXISTS public.check_rate_limit(target_user_id uuid, limit_type text, max_requests integer, window_seconds integer);
DROP FUNCTION IF EXISTS public.check_org_member(_org_id uuid, _user_id uuid);
DROP FUNCTION IF EXISTS public.check_org_admin(_org_id uuid, _user_id uuid);
DROP FUNCTION IF EXISTS public.check_helper_trust_score();
DROP FUNCTION IF EXISTS public.check_expired_dbs_certificates();
DROP FUNCTION IF EXISTS public.check_campaign_limit(org_id uuid, user_id uuid);
DROP FUNCTION IF EXISTS public.check_campaign_limit();
DROP FUNCTION IF EXISTS public.check_ai_rate_limit(p_user_id uuid, p_endpoint_name text, p_max_requests integer, p_window_minutes integer);
DROP FUNCTION IF EXISTS public.can_view_profile(profile_user_id uuid, viewer_id uuid);
DROP FUNCTION IF EXISTS public.can_award_badge(p_badge_id uuid, p_user_id uuid);
DROP FUNCTION IF EXISTS public.can_access_message(message_sender_id uuid, message_recipient_id uuid);
DROP FUNCTION IF EXISTS public.can_access_donor_details(org_id uuid);
DROP FUNCTION IF EXISTS public.can_access_dashboard(user_uuid uuid);
DROP FUNCTION IF EXISTS public.calculate_user_similarity_with_orgs(user1_id uuid, user2_id uuid);
DROP FUNCTION IF EXISTS public.calculate_user_similarity(user1_id uuid, user2_id uuid);
DROP FUNCTION IF EXISTS public.calculate_user_impact_metrics(target_user_id uuid);
DROP FUNCTION IF EXISTS public.calculate_trust_score(user_uuid uuid);
DROP FUNCTION IF EXISTS public.calculate_total_market_value(target_user_id uuid);
DROP FUNCTION IF EXISTS public.calculate_response_time();
DROP FUNCTION IF EXISTS public.calculate_organization_trust_score(org_id uuid);
DROP FUNCTION IF EXISTS public.calculate_esg_score(org_id uuid, assessment_year integer);
DROP FUNCTION IF EXISTS public.calculate_enhanced_trust_score(user_uuid uuid);
DROP FUNCTION IF EXISTS public.calculate_distance(lat1 numeric, lon1 numeric, lat2 numeric, lon2 numeric);
DROP FUNCTION IF EXISTS public.calculate_campaign_performance_score(campaign_uuid uuid);
DROP FUNCTION IF EXISTS public.bulk_mark_notifications_read(notification_ids uuid[], mark_all boolean);
DROP FUNCTION IF EXISTS public.bulk_delete_notifications(notification_ids uuid[], older_than_days integer);
DROP FUNCTION IF EXISTS public.award_user_points(target_user_id uuid, activity_type text, points integer, description text, metadata jsonb);
DROP FUNCTION IF EXISTS public.award_impact_points(target_user_id uuid, activity_type text, points integer, description text, metadata jsonb);
DROP FUNCTION IF EXISTS public.auto_generate_esg_report();
DROP FUNCTION IF EXISTS public.archive_old_reports();
DROP FUNCTION IF EXISTS public.approve_waitlist_user(target_user_id uuid, approving_admin_id uuid);
DROP FUNCTION IF EXISTS public.apply_point_decay();
DROP FUNCTION IF EXISTS public.admin_revoke_founding_member(target_user_id uuid, admin_user_id uuid, reason_text text);
DROP FUNCTION IF EXISTS public.admin_grant_founding_member(target_user_id uuid, admin_user_id uuid, reason_text text);
DROP FUNCTION IF EXISTS public.admin_assign_subscription(target_user_id uuid, plan_uuid uuid, billing_cycle_type text, admin_user_id uuid, reason_text text);
DROP FUNCTION IF EXISTS public.accept_organization_invitation(token_input text);
DROP TYPE IF EXISTS public.waitlist_status;
DROP TYPE IF EXISTS public.safeguarding_role;
DROP TYPE IF EXISTS public.feedback_type;
DROP TYPE IF EXISTS public.feedback_status;
DROP TYPE IF EXISTS public.feedback_priority;
...
--
-- Data for Name: admin_action_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.admin_action_log (id, admin_id, action_type, target_user_id, details, ip_address, created_at) FROM stdin;
\.
...
COPY public.admin_roles (id, user_id, role, granted_by, granted_at) FROM stdin;
\.


--
-- Data for Name: advertising_bookings; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.advertising_bookings (id, organisation_id, payment_id, ad_type, start_date, end_date, content, impressions, clicks, status, created_at) FROM stdin;
\.


--
-- Data for Name: ai_endpoint_rate_limits; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.ai_endpoint_rate_limits (id, user_id, endpoint_name, request_count, window_start, created_at) FROM stdin;
\.


--
-- Data for Name: badge_award_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.badge_award_log (id, user_id, badge_id, awarded_at, awarded_by, verification_status, evidence_submitted, contribution_details, campaign_id, activity_ids, revoked_at, revoked_by, revocation_reason, metadata) FROM stdin;
\.
...
COPY public.badges (id, name, description, icon, color, requirement_type, requirement_value, rarity, is_active, created_at, updated_at, campaign_id, event_identifier, availability_window_start, availability_window_end, limited_edition, max_awards, current_award_count, verification_required, evidence_requirements, cooldown_hours, max_per_user, badge_category) FROM stdin;
\.
...
COPY public.blog_posts (id, title, slug, excerpt, content, author_id, category_id, featured_image, tags, meta_description, meta_keywords, read_time, published_at, is_published, view_count, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: business_partnerships; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.business_partnerships (id, organization_id, partner_name, partnership_type, description, status, start_date, end_date, value, contact_person, contact_email, objectives, deliverables, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: business_products; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.business_products (id, organization_id, name, description, category, price_range, target_audience, launch_date, status, features, images, social_impact_statement, website_url, contact_email, contact_phone, is_featured, view_count, created_at, updated_at) FROM stdin;
\.
...
COPY public.campaign_analytics (id, campaign_id, date, total_views, unique_views, total_donations, donation_amount, social_shares, comment_count, conversion_rate, bounce_rate, avg_time_on_page, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: campaign_detailed_analytics; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_detailed_analytics (id, campaign_id, date, views, unique_visitors, shares, donations_count, donations_amount, new_donors, returning_donors, conversion_rate, average_donation, traffic_sources, demographics, created_at) FROM stdin;
\.


--
-- Data for Name: campaign_donations; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_donations (id, campaign_id, donor_id, amount, currency, donation_type, source, referrer_url, device_type, location_country, location_city, payment_processor, payment_status, is_anonymous, donor_message, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: campaign_engagement; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_engagement (id, campaign_id, user_id, action_type, session_id, ip_address, user_agent, referrer_url, time_spent, device_type, location_country, location_city, created_at) FROM stdin;
\.


--
-- Data for Name: campaign_geographic_impact; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_geographic_impact (id, campaign_id, country_code, country_name, city, region, total_donations, donor_count, total_views, total_shares, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: campaign_interactions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_interactions (id, campaign_id, user_id, interaction_type, content, created_at, updated_at, parent_id, is_deleted, organization_id) FROM stdin;
\.


--
-- Data for Name: campaign_invitations; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_invitations (id, campaign_id, inviter_id, invitee_email, invitee_id, invitation_type, message, status, expires_at, sent_at, responded_at) FROM stdin;
\.
...
COPY public.campaign_participants (id, campaign_id, user_id, participant_type, role, contribution_amount, contribution_type, message, is_anonymous, joined_at) FROM stdin;
\.


--
-- Data for Name: campaign_predictions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_predictions (id, campaign_id, prediction_type, predicted_value, confidence_score, prediction_date, actual_value, model_version, created_at) FROM stdin;
\.


--
-- Data for Name: campaign_promotions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_promotions (id, campaign_id, promotion_type, budget_spent, impressions, clicks, conversions, start_date, end_date, is_active, created_at) FROM stdin;
\.


--
-- Data for Name: campaign_social_metrics; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_social_metrics (id, campaign_id, platform, metric_type, value, date, external_post_id, created_at) FROM stdin;
\.


--
-- Data for Name: campaign_sponsorships; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.campaign_sponsorships (id, campaign_id, organization_id, sponsorship_tier, amount_pledged, amount_paid, benefits, visibility_type, status, created_at, activated_at, updated_at) FROM stdin;
\.
...
COPY public.campaign_updates (id, campaign_id, author_id, title, content, update_type, media_attachments, is_public, created_at) FROM stdin;
\.
...
COPY public.campaigns (id, creator_id, title, description, story, category, organization_type, goal_type, goal_amount, current_amount, currency, start_date, end_date, location, urgency, status, featured_image, gallery_images, tags, visibility, allow_anonymous_donations, enable_comments, enable_updates, social_links, custom_fields, promotion_budget, total_views, total_shares, created_at, updated_at, organizer, exclusive_badge_id, badge_criteria) FROM stdin;
\.


--
-- Data for Name: carbon_footprint_data; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.carbon_footprint_data (id, organization_id, scope_type, emission_source, activity_data, activity_unit, emission_factor, co2_equivalent, reporting_period, verification_status, notes, created_by, created_at, updated_at) FROM stdin;
\.
...
COPY public.connections (id, requester_id, addressee_id, status, created_at, updated_at) FROM stdin;
\.
...
COPY public.contact_submissions (id, name, email, subject, message, contact_type, status, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: content_appeals; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.content_appeals (id, report_id, user_id, appeal_reason, status, reviewed_by, reviewed_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.content_reports (id, reported_by, content_id, content_type, content_owner_id, reason, details, status, reviewed_by, reviewed_at, resolution_notes, created_at, updated_at) FROM stdin;
\.
...
COPY public.content_translations (id, content_id, content_type, original_language, target_language, original_text, translated_text, translator, created_at, expires_at) FROM stdin;
\.
...
COPY public.conversation_participants (id, conversation_id, user_id, joined_at, last_read_at, deleted_at) FROM stdin;
\.
...
--
-- Data for Name: corporate_partnerships; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.corporate_partnerships (id, organization_id, company_name, contact_person, contact_email, contact_phone, partnership_type, status, partnership_value, start_date, end_date, renewal_date, benefits_offered, requirements, notes, documents, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: csr_initiatives; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.csr_initiatives (id, organization_id, title, description, category, status, budget_allocated, budget_spent, start_date, end_date, target_beneficiaries, actual_beneficiaries, impact_metrics, sdg_goals, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: csr_lead_tracking; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.csr_lead_tracking (id, organization_id, post_id, campaign_id, action_type, user_id, metadata, created_at) FROM stdin;
\.


--
-- Data for Name: csr_opportunities; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.csr_opportunities (id, organization_id, post_id, status, notes, estimated_value, actual_value, created_at, updated_at, completed_at) FROM stdin;
\.


--
-- Data for Name: demo_request_activity_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.demo_request_activity_log (id, demo_request_id, actor_id, action_type, old_value, new_value, notes, created_at) FROM stdin;
\.
...
COPY public.demo_requests (id, full_name, email, company_name, job_title, phone_number, organization_size, preferred_date, preferred_time, interest_areas, message, status, priority, assigned_to, scheduled_meeting_time, meeting_link, meeting_duration_minutes, admin_notes, follow_up_notes, last_contacted_at, source, utm_source, utm_medium, utm_campaign, ip_address, user_agent, created_at, updated_at, completed_at) FROM stdin;
\.
...
COPY public.donors (id, organization_id, user_id, email, first_name, last_name, phone, address, donor_type, preferred_contact_method, communication_preferences, total_donated, donation_count, first_donation_date, last_donation_date, average_donation, donor_status, notes, tags, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: employee_engagement; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.employee_engagement (id, organization_id, employee_id, activity_type, title, description, hours_contributed, impact_points, verification_status, completed_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_announcements; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_announcements (id, organization_id, title, content, announcement_type, target_audience, published_at, created_by, view_count, engagement_count, created_at) FROM stdin;
\.


--
-- Data for Name: esg_benchmarks; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_benchmarks (id, industry_sector, indicator_id, benchmark_type, value, unit, data_source, reporting_year, geographical_scope, sample_size, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_compliance_reports; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_compliance_reports (id, organization_id, framework_id, report_type, reporting_period_start, reporting_period_end, status, generated_data, report_url, generated_by, approved_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_data_entries; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_data_entries (id, organization_id, indicator_id, reporting_period, value, text_value, unit, data_source, verification_status, supporting_documents, notes, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_data_requests; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_data_requests (id, organization_id, requested_from_org_id, requested_from_email, indicator_id, framework_id, reporting_period, due_date, priority, status, request_message, created_by, created_at, updated_at, initiative_id) FROM stdin;
\.


--
-- Data for Name: esg_frameworks; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_frameworks (id, name, code, version, description, official_url, is_active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_goals; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_goals (id, organization_id, indicator_id, goal_name, description, target_value, target_unit, baseline_value, baseline_year, target_year, current_value, progress_percentage, status, priority_level, category, milestones, responsible_team, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_indicators; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_indicators (id, framework_id, indicator_code, name, description, category, subcategory, unit_of_measurement, calculation_method, is_quantitative, reporting_frequency, materiality_level, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_initiative_templates; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_initiative_templates (id, name, framework_id, category, description, required_indicators, suggested_stakeholder_types, typical_duration_days, milestone_templates, is_active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_initiatives; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_initiatives (id, organization_id, initiative_name, initiative_type, framework_id, reporting_period_start, reporting_period_end, due_date, status, target_stakeholder_groups, progress_percentage, description, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_recommendations; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_recommendations (id, organization_id, recommendation_type, priority_score, title, description, recommended_actions, potential_impact, implementation_effort, estimated_cost_range, related_indicators, data_sources, confidence_score, status, reviewed_by, reviewed_at, implementation_date, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_report_versions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_report_versions (id, report_id, version_number, snapshot_data, pdf_url, html_url, created_at, created_by) FROM stdin;
\.


--
-- Data for Name: esg_reports; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_reports (id, organization_id, report_name, report_type, framework_version, reporting_period_start, reporting_period_end, status, template_data, generated_content, cover_image, executive_summary, created_by, approved_by, published_at, created_at, updated_at, initiative_id, report_version, is_final, previous_version_id, pdf_url, html_url, file_size_bytes, report_format, download_count, archived_at) FROM stdin;
\.


--
-- Data for Name: esg_risks; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_risks (id, organization_id, risk_name, risk_category, risk_type, description, probability_score, impact_score, mitigation_strategies, residual_risk_score, owner_department, review_frequency, last_reviewed, next_review_date, status, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_targets; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_targets (id, organization_id, indicator_id, target_name, baseline_value, target_value, baseline_year, target_year, progress_percentage, status, description, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: esg_verification_audit_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.esg_verification_audit_log (id, contribution_id, action_type, performed_by, notes, previous_status, new_status, created_at) FROM stdin;
\.


--
-- Data for Name: evidence_submissions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.evidence_submissions (id, user_id, activity_id, evidence_type, file_url, metadata, verification_status, verified_by, verified_at, rejection_reason, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: fraud_detection_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.fraud_detection_log (id, user_id, detection_type, threshold_value, actual_value, time_window, metadata, risk_score, auto_flagged, reviewed, reviewer_id, created_at) FROM stdin;
\.
...
COPY public.grants (id, organization_id, funder_name, grant_title, amount_requested, amount_awarded, application_deadline, decision_date, project_start_date, project_end_date, status, application_status, grant_type, focus_area, eligibility_requirements, application_requirements, notes, documents, reporting_requirements, created_at, updated_at) FROM stdin;
\.
...
COPY public.groups (id, name, description, cover_image, category, is_private, location, tags, admin_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: help_completion_requests; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.help_completion_requests (id, post_id, helper_id, requester_id, status, helper_message, feedback_rating, feedback_message, completion_evidence, created_at, reviewed_at, expires_at) FROM stdin;
\.


--
-- Data for Name: impact_activities; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.impact_activities (id, user_id, activity_type, points_earned, description, metadata, verified, created_at, updated_at, effort_level, requires_evidence, evidence_submitted, risk_score, auto_verified, skill_category_id, hours_contributed, market_rate_used, market_value_gbp, points_conversion_rate, organization_id, post_id, confirmed_by, confirmation_status, confirmed_at, rejection_reason, confirmation_requested_at, points_state, trust_score_at_award) FROM stdin;
\.


--
-- Data for Name: impact_goals; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.impact_goals (id, user_id, title, description, target_value, current_value, deadline, category, is_active, created_at, updated_at) FROM stdin;
\.
...
COPY public.impact_metrics (id, user_id, impact_score, trust_score, help_provided_count, help_received_count, volunteer_hours, donation_amount, connections_count, response_time_hours, calculated_at, average_rating, red_flag_count, last_activity_date, xp_points, decay_applied_count, total_market_value_contributed) FROM stdin;
\.


--
-- Data for Name: language_detection_cache; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.language_detection_cache (content_hash, detected_language, confidence, created_at) FROM stdin;
\.


--
-- Data for Name: materiality_assessments; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.materiality_assessments (id, organization_id, assessment_year, stakeholder_importance, business_impact, indicator_id, priority_level, stakeholder_feedback, action_plan, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: message_access_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.message_access_log (id, user_id, message_id, access_type, ip_address, user_agent, created_at) FROM stdin;
\.
...
COPY public.messages (id, sender_id, recipient_id, content, message_type, file_url, file_name, file_size, is_read, created_at, updated_at, attachment_type, attachment_url, attachment_name, attachment_size, delivered_at, read_at) FROM stdin;
\.
...
COPY public.newsletter_subscriptions (id, email, first_name, interests, frequency, gdpr_consent, is_active, subscribed_at, unsubscribed_at, created_at) FROM stdin;
\.


--
-- Data for Name: notification_analytics; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.notification_analytics (id, notification_id, user_id, event_type, event_metadata, created_at) FROM stdin;
\.
...
COPY public.notification_delivery_log (id, notification_id, user_id, delivery_method, delivered_at, opened_at, clicked_at, action_taken, device_info, created_at) FROM stdin;
\.


--
-- Data for Name: notification_filters; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.notification_filters (id, user_id, name, filter_config, is_default, created_at, updated_at) FROM stdin;
\.
...
COPY public.notification_templates (id, name, description, type, title_template, message_template, default_priority, default_action_type, metadata_schema, is_active, created_by, created_at, updated_at) FROM stdin;
\.
...
COPY public.notifications (id, recipient_id, sender_id, type, title, message, metadata, is_read, created_at, priority, action_url, action_type, grouped_with, delivery_status, group_key, read_at) FROM stdin;
\.
...
COPY public.organization_activities (id, organization_id, activity_type, title, description, impact_value, beneficiaries_count, location, related_campaign_id, media_urls, created_at, published_at) FROM stdin;
\.


--
-- Data for Name: organization_esg_data; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_esg_data (id, organization_id, indicator_id, reporting_period, value, text_value, unit, data_source, verification_status, notes, collected_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: organization_followers; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_followers (id, organization_id, follower_id, followed_at, notifications_enabled) FROM stdin;
\.


--
-- Data for Name: organization_impact_metrics; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_impact_metrics (id, organization_id, total_funds_raised, total_people_helped, total_volunteer_hours, active_campaigns, completed_projects, carbon_offset_kg, geographic_reach_countries, partner_organizations, last_calculated, created_at, updated_at) FROM stdin;
\.
...
COPY public.organization_invitations (id, organization_id, email, role, title, invited_by, invitation_token, status, expires_at, created_at, accepted_at, invitation_type, esg_context) FROM stdin;
\.
...
COPY public.organization_members (id, organization_id, user_id, role, title, department, start_date, end_date, is_public, is_active, verified_by, verified_at, created_at, updated_at, esg_role) FROM stdin;
\.


--
-- Data for Name: organization_preferences; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_preferences (id, organization_id, preference_type, preference_value, weight, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: organization_reviews; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_reviews (id, organization_id, reviewer_id, rating, review_text, reviewer_type, is_verified, is_anonymous, helpful_count, created_at, updated_at) FROM stdin;
\.
...
COPY public.organization_settings (id, organization_id, branding, communication_templates, donation_settings, volunteer_settings, analytics_preferences, notification_preferences, integration_settings, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: organization_team_members; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_team_members (id, organization_id, user_id, role, title, permissions, invited_by, invited_at, joined_at, is_active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: organization_trust_scores; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_trust_scores (id, organization_id, overall_score, verification_score, transparency_score, engagement_score, esg_score, review_score, calculated_at, created_at) FROM stdin;
\.


--
-- Data for Name: organization_verifications; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.organization_verifications (id, organization_id, verification_type, status, verified_at, verified_by, documents, notes, expires_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.organizations (id, name, organization_type, description, mission, vision, website, location, avatar_url, banner_url, established_year, registration_number, contact_email, contact_phone, social_links, tags, is_verified, verification_status, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: partnership_enquiries; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.partnership_enquiries (id, organisation_name, contact_name, email, phone, partnership_type, message, status, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: payment_references; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.payment_references (id, reference_code, payment_id, expected_amount, currency, expires_at, used_at, status, created_at) FROM stdin;
\.


--
-- Data for Name: platform_feedback; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.platform_feedback (id, user_id, feedback_type, title, description, page_url, page_section, screenshot_url, browser_info, priority, status, admin_notes, resolved_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: platform_payments; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.platform_payments (id, user_id, organisation_id, payment_type, payment_method, amount, currency, yapily_payment_id, yapily_consent_id, yapily_institution_id, payment_reference, bank_transfer_details, status, description, metadata, payment_date, reconciled_at, created_at) FROM stdin;
\.


--
-- Data for Name: point_decay_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.point_decay_log (id, user_id, points_before, points_after, decay_percentage, reason, last_activity_date, applied_at) FROM stdin;
\.


--
-- Data for Name: point_redemptions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.point_redemptions (id, user_id, reward_id, points_cost, status, redeemed_at, metadata) FROM stdin;
\.


--
-- Data for Name: points_configuration; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.points_configuration (id, config_key, config_value, description, category, updated_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: post_interactions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.post_interactions (id, post_id, user_id, interaction_type, content, created_at, parent_comment_id, edited_at, is_deleted, organization_id) FROM stdin;
\.
...
COPY public.posts (id, author_id, title, content, category, location, urgency, media_urls, tags, visibility, is_active, created_at, updated_at, link_preview_url, link_preview_data, import_source, external_id, import_metadata, imported_at, organization_id, latitude, longitude) FROM stdin;
\.
...
COPY public.profiles (id, first_name, last_name, phone, location, bio, avatar_url, banner_url, skills, interests, website, facebook, twitter, instagram, linkedin, created_at, updated_at, banner_type, waitlist_status, waitlist_approved_by, approved_at, waitlist_notes, admin_notes, latitude, longitude, location_updated_at, location_sharing_enabled, is_founding_member, founding_member_granted_at, founding_member_granted_by, user_type, email) FROM stdin;
\.
...
COPY public.questionnaire_responses (id, user_id, user_type, response_data, motivation, agree_to_terms, completed_at, created_at, updated_at) FROM stdin;
\.
...
COPY public.rate_limit_buckets (id, user_id, bucket_type, tokens, max_tokens, refill_rate, last_refill, created_at) FROM stdin;
\.
...
COPY public.recommendation_cache (id, user_id, recommendation_type, target_id, confidence_score, reasoning, metadata, created_at, expires_at) FROM stdin;
\.
...
COPY public.red_flags (id, user_id, flag_type, severity, description, evidence, status, flagged_by, resolved_by, resolved_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: relive_stories; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.relive_stories (id, post_id, title, category, cover_image, start_date, completed_date, total_impact, preview_text, emotions, created_at, updated_at) FROM stdin;
\.
...
COPY public.reports (id, reporter_id, reported_user_id, reported_post_id, report_type, reason, status, created_at, reviewed_at, reviewed_by) FROM stdin;
\.


--
-- Data for Name: safe_space_audit_log; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_audit_log (id, user_id, action_type, resource_type, resource_id, details, ip_address, user_agent, created_at) FROM stdin;
\.


--
-- Data for Name: safe_space_emergency_alerts; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_emergency_alerts (id, session_id, message_id, alert_type, severity, risk_score, detected_keywords, ai_analysis, status, assigned_to, acknowledged_at, resolved_at, resolution_notes, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: safe_space_flagged_keywords; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_flagged_keywords (id, keyword, category, severity, requires_immediate_escalation, is_active, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: safe_space_helper_applications; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_helper_applications (id, user_id, application_status, personal_statement, experience_description, qualifications, reference_contacts, availability_commitment, preferred_specializations, reviewed_by, reviewer_notes, rejection_reason, submitted_at, reviewed_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: safe_space_helper_training_progress; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_helper_training_progress (id, user_id, module_id, status, score, attempts, time_spent_minutes, answers, completed_at, created_at, updated_at, last_attempt_at, can_retry_at) FROM stdin;
\.


--
-- Data for Name: safe_space_helpers; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_helpers (id, user_id, specializations, is_available, max_concurrent_sessions, current_sessions, verification_status, professional_credentials, created_at, updated_at, last_active, emergency_contact_name, emergency_contact_phone, emergency_contact_relationship, dbs_required, trust_score, id_verification_status, last_verification_check) FROM stdin;
\.


--
-- Data for Name: safe_space_messages; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_messages (id, session_id, sender_role, content, message_type, created_at, expires_at, encrypted_content, is_encrypted) FROM stdin;
\.


--
-- Data for Name: safe_space_queue; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_queue (id, requester_id, issue_category, urgency_level, preferred_helper_type, additional_info, position_in_queue, created_at, estimated_wait_minutes) FROM stdin;
\.


--
-- Data for Name: safe_space_reference_checks; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_reference_checks (id, application_id, reference_name, reference_email, reference_phone, relationship, verification_token, questionnaire_responses, status, submitted_at, expires_at, created_at) FROM stdin;
\.


--
-- Data for Name: safe_space_sessions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_sessions (id, requester_id, helper_id, session_token, issue_category, urgency_level, status, created_at, started_at, ended_at, duration_minutes, feedback_rating, metadata, session_paused, paused_reason, paused_at, paused_by) FROM stdin;
\.


--
-- Data for Name: safe_space_training_modules; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_training_modules (id, title, description, content_type, content_url, content_html, quiz_questions, duration_minutes, passing_score, order_sequence, is_required, is_active, category, created_at, updated_at, max_attempts, retry_delay_days, question_count, difficulty_level) FROM stdin;
\.


--
-- Data for Name: safe_space_verification_documents; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safe_space_verification_documents (id, user_id, application_id, document_type, file_path, file_name, file_size, mime_type, verification_status, verified_by, verified_at, rejection_reason, metadata, created_at, dbs_certificate_number, dbs_issue_date, dbs_expiry_date, dbs_check_level) FROM stdin;
\.


--
-- Data for Name: safeguarding_roles; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.safeguarding_roles (id, user_id, role, assigned_by, assigned_at, is_active, created_at, updated_at) FROM stdin;
\.
...
COPY public.scheduled_notifications (id, template_id, recipient_id, sender_id, scheduled_for, title, message, type, priority, action_url, action_type, metadata, status, sent_at, error_message, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: seasonal_challenges; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.seasonal_challenges (id, title, description, start_date, end_date, point_multiplier, target_categories, max_progress, reward_description, is_active, created_at) FROM stdin;
\.
...
COPY public.security_audit_log (id, user_id, action_type, resource_type, resource_id, ip_address, user_agent, severity, details, created_at) FROM stdin;
\.
...
COPY public.skill_categories (id, name, category, market_rate_gbp, requires_verification, evidence_required, description, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: stakeholder_data_contributions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.stakeholder_data_contributions (id, data_request_id, esg_data_id, contributor_org_id, contributor_user_id, contribution_status, submitted_at, reviewed_at, reviewed_by, review_notes, created_at, verification_status, verified_by, verified_at, verification_notes, revision_requested_notes, supporting_documents, draft_data, last_saved_at) FROM stdin;
\.


--
-- Data for Name: stakeholder_engagement_metrics; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.stakeholder_engagement_metrics (id, organization_id, stakeholder_type, metric_name, metric_value, metric_unit, measurement_date, engagement_method, response_rate, satisfaction_score, notes, created_by, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: stakeholder_groups; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.stakeholder_groups (id, organization_id, group_name, stakeholder_type, description, engagement_methods, contact_frequency, key_interests, influence_level, is_active, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: story_participants; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.story_participants (id, post_id, user_id, role, participation_type, joined_at) FROM stdin;
\.


--
-- Data for Name: story_updates; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.story_updates (id, post_id, author_id, update_type, title, content, media_url, media_type, emotions, stats, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: subscription_admin_actions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.subscription_admin_actions (id, admin_id, target_user_id, action_type, action_details, reason, created_at) FROM stdin;
\.
...
COPY public.subscription_plans (id, name, price_monthly, price_annual, features, max_campaigns, max_team_members, white_label_enabled, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: support_actions; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.support_actions (id, post_id, user_id, action_type, status, metadata, created_at) FROM stdin;
\.


--
-- Data for Name: trust_domains; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.trust_domains (id, user_id, domain, domain_score, actions_count, average_rating, last_activity, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: trust_score_history; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.trust_score_history (id, user_id, previous_score, new_score, change_reason, verification_id, created_at) FROM stdin;
\.


--
-- Data for Name: tutorial_preferences; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.tutorial_preferences (id, user_id, show_tutorials, dismissed_tutorials, created_at, updated_at) FROM stdin;
\.
...
COPY public.typing_indicators (id, user_id, conversation_partner_id, is_typing, updated_at) FROM stdin;
\.


--
-- Data for Name: url_previews; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.url_previews (id, url, title, description, image_url, site_name, favicon, metadata, created_at, expires_at) FROM stdin;
\.
...
COPY public.user_achievements (id, user_id, achievement_id, unlocked_at, progress, max_progress, metadata) FROM stdin;
\.
...
COPY public.user_activities (id, user_id, activity_type, title, description, metadata, visibility, created_at) FROM stdin;
\.
...
COPY public.user_badges (id, user_id, badge_id, earned_at, progress, metadata) FROM stdin;
\.
...
--
-- Data for Name: user_challenge_progress; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.user_challenge_progress (id, user_id, challenge_id, progress, completed_at, created_at) FROM stdin;
\.


--
-- Data for Name: user_interaction_scores; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.user_interaction_scores (id, user_id, target_user_id, target_post_id, interaction_type, score_value, created_at) FROM stdin;
\.
...
COPY public.user_language_preferences (id, user_id, preferred_language, auto_translate, show_translation_button, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_preferences (id, user_id, preference_type, preference_value, weight, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_presence (user_id, is_online, last_seen, typing_to_user_id, typing_started_at, updated_at) FROM stdin;
\.
...
COPY public.user_privacy_settings (id, user_id, profile_visibility, allow_direct_messages, show_online_status, show_location, show_email, show_phone, allow_tagging, show_activity_feed, created_at, updated_at) FROM stdin;
\.
...
COPY public.user_subscriptions (id, user_id, organisation_id, plan_id, yapily_consent_id, status, billing_cycle, current_period_start, current_period_end, next_payment_date, cancel_at_period_end, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: user_tutorial_progress; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.user_tutorial_progress (id, user_id, tutorial_type, user_type, steps_completed, total_steps, current_step, is_completed, dismissed, started_at, completed_at, last_step_at, created_at) FROM stdin;
\.
...
COPY public.user_verifications (id, user_id, verification_type, status, verification_data, verified_at, expires_at, verified_by, notes, created_at, updated_at, face_match_score, liveness_check_passed, face_embedding) FROM stdin;
\.


--
-- Data for Name: verification_document_audit; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.verification_document_audit (id, document_id, accessed_by, action_type, ip_address, user_agent, created_at) FROM stdin;
\.
...
COPY public.verification_documents (id, verification_id, user_id, document_type, file_path, file_name, file_size, mime_type, uploaded_at, created_at, face_detected, face_quality_score) FROM stdin;
\.


--
-- Data for Name: volunteer_applications; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.volunteer_applications (id, opportunity_id, user_id, application_message, availability, relevant_experience, emergency_contact, background_check_status, training_status, status, applied_at, reviewed_at, reviewed_by, start_date, end_date, hours_logged) FROM stdin;
\.


--
-- Data for Name: volunteer_interests; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.volunteer_interests (id, post_id, volunteer_id, status, message, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: volunteer_opportunities; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.volunteer_opportunities (id, organization_id, created_by, title, description, requirements, skills_needed, time_commitment, location, is_remote, start_date, end_date, max_volunteers, current_volunteers, status, application_deadline, background_check_required, training_required, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: volunteer_work_notifications; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.volunteer_work_notifications (id, activity_id, recipient_id, volunteer_id, notification_type, is_read, created_at, metadata) FROM stdin;
\.


--
-- Data for Name: white_label_purchases; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.white_label_purchases (id, organisation_id, payment_id, configuration, status, licence_start_date, licence_end_date, created_at) FROM stdin;
\.
...
\unrestrict TXRV0OWl1b8VmwhRFBHrCwZaI5ZZne6zKo6Gim5wiyFj1W4wOdtFneupNMjhe3G
